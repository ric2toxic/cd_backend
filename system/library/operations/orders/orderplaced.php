...
/**
 * Order Placed State
 * @info All methods of order placed state can be write here.
 * @author: Sudhanshu Jain
 * @date: 27-Oct-2016
 */
require_once ('orderstatebase.php');
class OrderPlaced extends OrderStateBase{
  private $post_action = array();
    ...
    public function __construct($registry,$orderid,$suborder_id){
      parent::__construct($registry,$orderid,$suborder_id); //Calling parent constructor
    }
    /**
     * doAction
    ...
    public function getPostAction() {
        // TODO: Implement getPostAction() method.
    }
