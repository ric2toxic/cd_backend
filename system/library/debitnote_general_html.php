...
<table style="width:100%;" border="1" cellspacing="" cellpadding="4">
    <tr> 
        <td style="width:50%;" rowspan="3">
            Document No. : <b>
            <?php echo $this->_debit_note_prefix . $pdf_data['debit_note_info']['debit_note_no']; ?></b>
            <br />
            Date of Issue :<b> <?php echo $pdf_data['debit_note_info']['debit_note_date']; ?></b><br />
    ...
    <tr>
        <td>Ref. P.O. :  <?php echo $pdf_data['debit_note_info']['order_no']; ?></td>
    </tr>
    <tr>
...
<?php $this->updateDebitNoteAmount($pdf_data['debit_note_info']['debit_note_id'], ((float)$total_taxable_value + (float)$total_tax_value)); ?>
<table style="width:100%;" border="1" cellspacing="" cellpadding="4">
    <tr align="center" >
