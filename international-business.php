...
<head>
    ...
    <title> Online Indian wholesale clothing store for bulk shopping</title>

    <!-- favicon icon -->
    <link href="https://www.wholesalebox.in/image/catalog/16_by_16_wsbIcon.png" rel="icon" />

    <meta name="description" content="Buy Indian ethnic wholesale clothing like sarees, suit catalogs, salwar kameez, kurtis, bedsheets & handicrafts at WholesaleBox." />
    ...
    <meta name="keywords" content= "Wholesale Clothing, kidswear, menswear, wholesale footwear, wholesale lingerie, wholesale shopping, wholesale womens clothing, wholesale home decor, wholesale fashion jewelry, wholesale online shopping, kids accessories" />
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-67389405-3"></script>
        <script>
             window.dataLayer = window.dataLayer || [];
             function gtag(){dataLayer.push(arguments)};
             gtag('js', new Date());  gtag('config', 'UA-67389405-3');
        </script>  

    <!-- awesome Fonts -->
    <link href="image/cdn/landing-page/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">

    <!-- Bootstrap Core CSS -->
    <link href="image/cdn/landing-page/css/bootstrap.min.css" rel="stylesheet" type="text/css">

    <!-- Custom CSS -->
    <link href="image/cdn/landing-page/css/custom.min.css" rel="stylesheet" type="text/css">
</head>
...
<nav class="navbar navbar-fixed-top header_section">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand scroll_effect" data-target="#lp-pom-root"><img src="<?php echo CDN_URL ?>cdn/landing-page/images/wsb_logo_blue.jpg" alt="wsb_logo"></a>
        </div>
        ...
        <div class="slider_bg_color">
            <div class="container slider_contant">
                <div class="slider_contant_text">
                    <h3>
                        Are you a shopkeeper/seller of Indian Fashion clothes, Footwear, Handbags or Home decor items?
                    </h3>
                    <span>
                            Yes, you are on right place. We are <b>online wholesalers</b> who provide all types of Indian fashion wholesale clothing, footwear, Handicrafts, bed-sheets etc. at a wholesale price with a <span class="green">guarantee of 25-30 % saving on your current buying.</span>
                            </span>
                            <div class="col-sm-12 slider_input_box slider_input_box_co">
                                <div class="mobile_btn">
                                  <a href="https://play.google.com/store/apps/details?id=in.wholesalebox&referrer=utm_source%3DLanding%26utm_medium%3Dgoogle_ad" target="_blank">
                                    <img src="<?php echo CDN_URL ?>cdn/landing-page/images/google-play-android-app.svg" alt="Android app on google play" width="180px">
                                    </a>
                                  <a href="https://itunes.apple.com/app/apple-store/id1254820324?pt=118706814&ct=landing-page&mt=8" target="_blank">
                                   <img src="<?php echo CDN_URL ?>cdn/landing-page/images/ios_download.svg" alt="ios app on app store" width="180px">
                                  </a>
                                  <a href="https://www.wholesalebox.co/?tracking=577e51791bc08" target="_blank">
                                    <img src="<?php echo CDN_URL ?>cdn/landing-page/images/wsb_website.svg" alt="wholesatebox website" width="180px">
                                   </a>
                                </div>
...
<!-- mobile app Section -->
<div class="container-fluid" id="mobile_app">
    <div class="container">
        <div class="row">
            <Section class="col-lg-12 content_space">
                <div class="col-sm-4">
                    <div class="info_img"><img src="<?php echo CDN_URL ?>cdn/landing-page/images/mobile_app.jpg" alt="mobile_app"></div>
                </div>
                <div class="col-sm-8">
                    <div class="info_content_box">
                        ...
                        <div class="mobile_btn">
                             <a href="https://play.google.com/store/apps/details?id=in.wholesalebox&referrer=utm_source%3DLanding%26utm_medium%3Dgoogle_ad" target="_blank"><img src="<?php echo CDN_URL ?>cdn/landing-page/images/google-play-android-app.svg" alt="Android app on google play" width="140px"></a>

                             <a href="https://itunes.apple.com/app/apple-store/id1254820324?pt=118706814&ct=landing-page&mt=8" target="_blank"><img src="<?php echo CDN_URL ?>cdn/landing-page/images/ios_download.svg" alt="ios app on app store" width="140px"></a>
                             <a href="https://www.wholesalebox.co/?tracking=577e51791bc08" target="_blank">
                              <img src="<?php echo CDN_URL ?>cdn/landing-page/images/wsb_website.svg" alt="wholesatebox website" width="140px">
                            </a>
                        </div>
                    </div>
                </div>
...
<div class="container" id="wholesaleBox_work">
    ...
    <div class="row">
        <Section class="col-lg-12 content_space">
            ...
            <div class="content_center content_center_co"><img src="<?php echo CDN_URL ?>cdn/landing-page/images/WSB_business_v2_co.jpg" alt="WholesaleBox work" class="img-responsive"></div>
        </Section>
    </div>
</div>
<!-- buy us Section -->
                ...
                <div class="text-center padding_text_contant_full">
                    ...
                    <div class="clearfix"></div>
                      <div class="business_btn">
                        <P>Run Your Business First, Leave The Rest To Us </P>
                         <div class="col-sm-12 nopadding business_in">
                          <div class="mobile_btn">
                            <a href="https://play.google.com/store/apps/details?id=in.wholesalebox&referrer=utm_source%3DLanding%26utm_medium%3Dgoogle_ad" target="_blank">
                             <img src="<?php echo CDN_URL ?>cdn/landing-page/images/google-play-android-app.svg" alt="Android app on google play" width="140px">
                            </a>
                            <a href="https://itunes.apple.com/app/apple-store/id1254820324?pt=118706814&ct=landing-page&mt=8" target="_blank">
                              <img src="<?php echo CDN_URL ?>cdn/landing-page/images/ios_download.svg" alt="ios app on app store" width="140px">
                            </a>
                             <a href="https://www.wholesalebox.co/?tracking=577e51791bc08" target="_blank">
                              <img src="<?php echo CDN_URL ?>cdn/landing-page/images/wsb_website.svg" alt="wholesatebox website" width="140px">
                            </a>
                        ...
                        <div class="text-center padding_text_contant">
                            <div class="carousel slide Shopkeepers_slider" id="fade-quote-carousel" data-ride="carousel" data-interval="3000">
                                ...
                                <div class="carousel-inner">
                                    <div>
                                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/testimonialtop.png" class="test_top" alt="">
                                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/testimonialbottom.png" class="test_bottom hidden-xs" alt="">
                                    </div>
                                    <div class="item">
                                        <blockquote>                                    
                                            <p> Kurtis arrived in excellent condition. Great quality for the price, made with excellent quality materials that are well. All of them are sold out. </p>
                                            <div><p class="testimonial"> Pamela </p></div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <p> Loved this collection from the moment I saw it on the website. The material, the stitching of the flowers and embroidery are so beautiful. All my customers loved the collection. </p>
                                            <div><p class="testimonial"> Dawn </p></div>
                                        </blockquote>
                                    </div>
                                    <div class="active item">
                                        <blockquote>
                                            <p> Very pleased with the quality and delivery service! Exactly how the collection looked like in the picture. All of the bedsheets are sold out. </p>
                                            <div><p class="testimonial"> Sherry </p></div>
                                        </blockquote>
                                    </div>
                                    <div class="item">
                                        <blockquote>
                                            <p> Great value for money as I sold them keeping high margins with me. </p>
                                            <div><p class="testimonial"> Vicki </p></div>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="text-center padding_text_contant">
                    ...
                    <div class="col-sm-6 video_section">
                        <div class="lp-pom-image-container" style="overflow: hidden;">
                            <img src="<?php echo CDN_URL ?>cdn/landing-page/images/lappy.png" alt="" class="img-responsive">
                        </div>
            ...
            <div class="row">
                <Section class="col-lg-12 content_space">
                    <div class="col-sm-3 wsb_info_box">
                        <span class="wsb_info_most">75930+</span>
                        <span>Designs</span>
                    </div>
                    <div class="col-sm-3 wsb_info_box">
                        <span class="wsb_info_most">34918+</span>
...
<footer>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="footer4">
                    ...
                    <div class = "col-sm-12" style="padding:0px;">
                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/fedex.png" class="Logistics_img" alt="FedEx is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12" style="padding:0px;">
                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/gatikwe.png" class="Logistics_img" alt="Gati is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12" style="padding:0px;">
                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/DTDC.png" class="Logistics_img" alt="DTDC is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12" style="padding:0px;">
                        <img src="<?php echo CDN_URL ?>cdn/landing-page/images/bluedart.png" class="Logistics_img" alt="BlueDart is our Logistics Partner">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12">
                <div class="trust_seal">
                    <img src="<?php echo CDN_URL ?>cdn/landing-page/images/wsb_seal_of_trust.png" class="Logistics_img" alt="BlueDart is our Logistics Partner">
                </div>
            </div>
    ...
    <!-- /.container -->
    <script src="<?php echo CDN_URL?>cdn/landing-page/js/jquery.min.js" type="text/javascript"></script>

    <script src="<?php echo CDN_URL?>cdn/landing-page/js/bootstrap.min.js" type="text/javascript"></script>

    <script src="<?php echo CDN_URL?>cdn/landing-page/js/custom.min.js" type="text/javascript"></script>
