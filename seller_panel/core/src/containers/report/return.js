...
export const ReturnReportIcon = Icon;
...
ProductField.defaultProps = { label: 'Product Value' };
 ...
 class returnReportList  extends Component {
 ...
 render(){ 
return(
    <List title="Returns Report" {...this.props} sort={{ field: 'order_date_added', order: 'DESC' }} filters={<ReturnFilter />}>
        <Datagrid>
            ...
            <CGSTField source="CGST" label="CGST" sortable={false}  />
