...
list(,,$consumer_count) = $channel->queue_declare('update_user_tentative_incentive', false, true, false, false);
...
$channel->basic_consume('update_user_tentative_incentive', '', false, false, false, false, $callback);
