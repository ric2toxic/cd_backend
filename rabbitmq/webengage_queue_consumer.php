...
try{
	...
	$callback = function($msg){
        ...
        if (!$result) {
			...
			$queue_name_republish = 'STAGING_WEBENGAGE_TASKS_QUEUE';
			if (SITE_ENVIRONMENT == 'Production') {
	   			$queue_name_republish = 'WEBENGAGE_TASKS_QUEUE';
			}
    ...
    $mail->Subject = 'Webenage Queue Consumer Error - ' . date('d/m/y H:i:s');
