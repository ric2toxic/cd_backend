...
if (is_file(__DIR__.'/../../config.php')) {
 ...
 require DIR_API."/../data_packet.php";
    abstract class API
    {
        /**
         * Property: method
        ...
        public function __construct($request) {
            ...
            $this->endpoint = $request['endpoint'];//array_shift($this->args);
            ...
            $this->method = $request['method'];//$_SERVER['REQUEST_METHOD'];
            ...
            switch($this->method) {
                ...
                case 'POST':
                    ...
                    break;
                case 'GET':
                    $this->request = $request; //$this->_cleanInputs($_GET);
                    break;
                case 'PUT':
        ...
        public function processAPI() {
            ...
            try{
                ...
                // Not throwing email for CRM API errors for now, as it is full of errors and mailbox gets full
                //$this->mailException($ex);
                $dp = new DataPacket();
                $dp->message = $ex->getMessage();
                $dp->statusCode = $ex->getCode();
                return $this->_response($dp);
        ...
        {  
            ...
            $mail->Subject = html_entity_decode('Exception in CRM API - '.date('d/M/Y h:i:s'), ENT_QUOTES, 'UTF-8');
            $mail->msgHTML($body);
            $mail->send();
        }
