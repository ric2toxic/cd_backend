<?php
class ControllerReactProfile extends Controller {
	...
	public function index()
	{
		...
		if( file_exists( DIR_TEMPLATE . $this->config->get('config_template') . 'template/react/profile.tpl' ) ) {
			$this->response->setOutput( $this->load->view( $this->config->get('config_template') . 'template/react/profile.tpl' , $data) );
		} else {
			$this->response->setOutput( $this->load->view( 'default/template/react/profile.tpl' , $data) );
		}
	}
	...
	public function address()
	{
		...
		if( file_exists( DIR_TEMPLATE . $this->config->get('config_template') . 'template/react/address.tpl' ) ) {
			$this->response->setOutput( $this->load->view( $this->config->get('config_template') . 'template/react/address.tpl' , $data) );
		} else {
			$this->response->setOutput( $this->load->view( 'default/template/react/address.tpl' , $data) );
		}
	}
	...
	public function bank_details()
	{
		...
		if( file_exists( DIR_TEMPLATE . $this->config->get('config_template') . 'template/react/bank_details.tpl' ) ) {
			$this->response->setOutput( $this->load->view( $this->config->get('config_template') . 'template/react/bank_details.tpl' , $data) );
		} else {
			$this->response->setOutput( $this->load->view( 'default/template/react/bank_details.tpl' , $data) );
		}
	}
