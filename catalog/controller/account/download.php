...
class ControllerAccountDownload extends Controller {
    ...
    public function productFeed() {
        ...
        // Custom feed file for perticular dropshipper, Customer Id - 181366
        if($this->customer->isLogged() && $this->customer->getId() == "181366"){

            if(file_exists(DIR_SYSTEM."upload/assets/feeds/custom_feed_products.csv")){
                header("Content-type:application/csv");

                // It will be called last_six_months_ordered_data.csv
                header("Content-Disposition:attachment;filename=custom_feed_products.csv");
                // The csv source is in last_six_months_ordered_data.csv
                readfile(DIR_SYSTEM."upload/assets/feeds/custom_feed_products.csv");
            }
        } else {
            ...
            if(file_exists(DIR_SYSTEM."upload/assets/feeds/products.csv")){
                ...
                // The csv source is in last_six_months_ordered_data.csv
                readfile(DIR_SYSTEM."upload/assets/feeds/products.csv");
            }
        }
	}
}