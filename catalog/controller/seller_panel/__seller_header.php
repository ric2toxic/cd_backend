...
class ControllerSellerPanelSellerHeader extends Controller {
    public function index(){
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/seller-panel/seller_header.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/seller-panel/seller_header.tpl', $data);
        } else {
            return $this->load->view('default/template/seller-panel/seller_header.tpl', $data);
        }
        ...
        $data['account_dashboard'] = $this->url->link('seller/account-dashboard','','SSL');
