...
class ControllerSellerManageInventory extends ControllerSellerAccount {
    ...
    public function index(){
        ...
        $sellerdataCount_wholesale = $this->model_seller_manage_inventory->getTotalSellerProducts($con_wholesale,$sort_wholesale, $cols);

        $filter_data['offset'] = ($page_wholesale - 1) * $limit;
        $sellerdata_wholesale = $this->model_seller_manage_inventory->getSellerProducts($con_wholesale, $filter_data, $cols);
        ...
        //echo "<pre>"; print_r($this->data['data_wholesale']); echo "</pre>";
        ...
        $this->data['form_action'] = 'index.php?route=seller/manage-inventory/index';
    ...
    public function addOfferToAParticularProduct() {
        ...
        $this->model_catalog_product->addOfferToAParticularProduct($this->request->post);
    }
