<?php
class ControllerSellerPanelPaymentReports extends Controller {
  ...
  public function index() {
    ...
    //$this->load->model('accounts/paymentsreport');
    ...
    $data['filter_invoice_date_range']  = '';
    ...
    if ( !empty($this->request->get['filter_date_range']) ) {
      $data['filter_date_range']           = $this->request->get['filter_date_range'];
      $filter_data['filter_date_range']    = $this->request->get['filter_date_range'];
      $pagination_filter .= "&filter_date_range=".urlencode($this->request->get['filter_date_range']);
    }
    if ( !empty($this->request->get['filter_invoice_date_range']) ) {
      $data['filter_invoice_date_range']           = $this->request->get['filter_invoice_date_range'];
      $filter_data['filter_invoice_date_range']    = $this->request->get['filter_invoice_date_range'];
      $pagination_filter .= "&filter_invoice_date_range=".urlencode($this->request->get['filter_invoice_date_range']);
    }
    if ( !empty($this->request->get['filter_payment_date_range']) ) {
      $data['filter_payment_date_range']           = $this->request->get['filter_payment_date_range'];
      $filter_data['filter_payment_date_range']    = $this->request->get['filter_payment_date_range'];
      $pagination_filter .= "&filter_payment_date_range=".urlencode($this->request->get['filter_payment_date_range']);
    }
    ...
    $pagination->url = $this->url->link('seller_panel/paymentreports', 'token=' . $this->session->data['token'] . $pagination_url . '&page={page}' . $pagination_filter, 'SSL');
    ...
    $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/accounts/paymentsreport.tpl', $data));
  ...
  private function _generatePaymentCsv($paymentData) {
    ...
    // setup csv file
    $file_name = 'Payment_Report_'.date("Y-m-d",time()).'_'.time().'.csv';
