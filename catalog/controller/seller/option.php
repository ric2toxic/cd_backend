...
class ControllerSellerOption extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('seller/option', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('seller/option', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('seller/option/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('seller/option/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$results = $this->model_seller_option->getOptions($filter_data);
		...
		foreach ($results as $result) {
			$data['options'][] = array(
				...
				'edit'       => $this->url->link('seller/option/edit', 'token=' . $this->session->data['token'] . '&option_id=' . $result['option_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('seller/option', 'token=' . $this->session->data['token'] . '&sort=od.name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('seller/option', 'token=' . $this->session->data['token'] . '&sort=o.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('seller/option', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('seller/option_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['option_id'])) {
			$data['action'] = $this->url->link('seller/option/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('seller/option/edit', 'token=' . $this->session->data['token'] . '&option_id=' . $this->request->get['option_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('seller/option', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('seller/option_form.tpl', $data));
	}
