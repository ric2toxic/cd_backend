	...
	public function quote() {
		...
		if (!$json) {
			...
			if($this->customer->isLogged()){
				if ($this->customer->is_dropshipper == 1 && isset($this->request->post['cartlimitcross']) && $this->request->post['cartlimitcross'] == 0) {
				...
				}else if ($this->customer->is_dropshipper == 1 &&  isset($this->request->post['cartlimitcross']) && $this->request->post['cartlimitcross'] == 1) {
