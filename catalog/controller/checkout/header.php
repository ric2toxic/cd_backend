...
class ControllerCheckoutHeader extends Controller {
    public function index() {
        ...
        $data['manufacturer_icon'] = $this->model_tool_image->getOriginalImage('MANUFACTURER.jpg');

        // return icon

        $data['return_icon'] = $this->model_tool_image->getOriginalImage('RETURNS.jpg');

        // delivery icon
         $data['delivery_icon'] = $this->model_tool_image->getOriginalImage('DELIVERY.jpg');

        // payment icon
         $data['payment_icon'] = $this->model_tool_image->getOriginalImage('PAYMENT.jpg');
