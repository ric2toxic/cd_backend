...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		if (isset($this->session->data["popup"])) {  
			$data['popup'] = $this->session->data["popup"];
		}
		
		//echo "<pre>";print_r($this->request->get); echo "</pre>"; die;
		// it is used for checkbox value then shipment address show or hide.
		if(isset($this->request->get['existing_check_ship_same_value'])){
			$data['existing_check_ship_same_value'] =  $this->request->get['existing_check_ship_same_value'];
		}
		if(isset($this->request->get['payment_check_ship_same_value'])){
			$data['payment_check_ship_same_value'] =  $this->request->get['payment_check_ship_same_value'];
		}
