...
$_['text_confirm']        = 'Are You sure You Want to delete coupon!';
$_['text_no_results']	  =	'No record Found';
// $_['text_download_csv']	  =	'Download csv for update product price and stock quantity.';
$_['text_download_csv']	  =	'Download csv to update %s product price and stock quantity.';
$_['text_wsb_download_csv']	  =	'Download csv to update Wholesalebox product price and stock quantity.';
$_['text_upload_csv']	  =	'Upload csv for %s here.';
$_['text_wsb_upload_csv']	  =	'Upload csv for Wholesalebox here.';
...
$_['ms_account_bulk_price']	  = 'Upload Bulk Price';
...
$_['error_filesize']   	  = 'Warning: Size of the image cannot be more than 1 MB!';
