...
$_['error_default']        = 'Warning: You can not delete your default address! please go to address book to set a new default address, in order to be able to delete the current default address.';
...
$_['error_postcode2']      = 'Postcode must be 6 numeric characters!';
