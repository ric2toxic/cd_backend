    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            var ctntDisplayArea = "<div class='gc-display-area'>" +
                                        ...
                                        "<div class='gc-icon gc-icon-next'><i class='fa fa-angle-right' aria-hidden='true'></i></div>" +
                                        "<div class='gc-icon gc-icon-prev'><i class='fa fa-angle-left' aria-hidden='true'></i></div>" +
            ...
            var ctntOverlayArea = "<div class='gc-overlay-area'>" +
                                    "<div class='gc-overlay-top-icons'>" +
                                     "<div class='gc-icon gc-icon-close'><i class='fa fa-times-circle' aria-hidden='true'></i>Â </div>" +
            ...
            var ctntThumbsPrevNext = "<div class='gc-thumbs-area-prev'><div class='gc-icon'><i class='fa fa-angle-up' aria-hidden='true'></i></div></div>" +
                                     "<div class='gc-thumbs-area-next'><div class='gc-icon '><i class='fa fa-angle-down' aria-hidden='true'></i></div></div>";
                    ...
                    gcBase.gcThumbsImg.each(function (index) {
                        ...
                        .on('error', function () {
                            ...
                            if (Modernizr.svg) {
                                ...
                                //gcBase.gcThumbsImg.eq(index).attr('src', "image/logo_for_product.svg"); 
