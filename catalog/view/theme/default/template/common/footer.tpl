<footer>
    ...
    <div class="container">
            ...
            <div class="col-sm-3">
                <div class="footer4">
                    ...
                    <div class = "col-sm-12 col-xs-8" style="padding:0px;">
                        <img src="<?php echo STATIC_CONTENT_URL_SSL ?>fedex.png" alt="FedEx is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12 col-xs-4" style="padding:0px;">
                        <img src="<?php echo STATIC_CONTENT_URL_SSL ?>gatikwe.png" alt="Gati is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12 col-xs-8" style="padding:0px;">
                        <img src="<?php echo STATIC_CONTENT_URL_SSL ?>DTDC.png" alt="DTDC is our Logistics Partner">
                    </div>
                    <div class = "col-sm-12 col-xs-8" style="padding:0px;">
                        <img src="<?php echo STATIC_CONTENT_URL_SSL ?>bluedart.png" alt="BlueDart is our Logistics Partner">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 app_link" style="padding:0px;">
                <p><?php echo $text_cashback;?></p>
                <a href="https://play.google.com/store/apps/details?id=in.wholesalebox" target="_blank">
                    <img src="<?php echo STATIC_CONTENT_URL_SSL ?>google-play-android-app.svg" alt="Android app on google play" width="130px">
                </a>
                <a href="https://itunes.apple.com/us/app/wholesalebox/id1254820324?mt=8" target="_blank">
                    <img src="<?php echo STATIC_CONTENT_URL_SSL ?>ios_download.svg" alt="ios app on app store" width="130px" class="pull-right">
                </a>
            </div>
...
<?php /* Its embeded in jquery-2.1.1.1.min.js ?>
<script  src="catalog/view/javascript/jquery/jquery-ui.js" type="text/javascript"></script>
<?php */ ?>
<?php /* Its embeded in bootstrap-min.js ?>
...
<?php */ ?>
<script  src="catalog/view/javascript/common-min.js?v=1" defer type="text/javascript"></script>
...
<script>
$(document).ready(function() {
    $('.colume_left_shadow').scrollToFixed({
        marginTop: function() {

           
           var marginTop = window.innerHeight - $('.colume_left_shadow').outerHeight(true) - 20;
            if (marginTop >= 0)
            {
              return 200;
            } 
        ...
        limit: function() {
                var limit = $('#product_description_box').offset().top - $('.colume_left_shadow').outerHeight(true) - 10;
                return limit;
            },
        zIndex: 10,    
