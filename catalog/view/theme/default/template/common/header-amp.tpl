...
<head>
    ...
    <?php  ?>
    <link href="catalog/view/theme/default/stylesheet/stylesheet_new_amp.css?v=10" rel="stylesheet" />
...
<?php if ($store_id == INTERNATIONAL_STORE_ID) { ?>
        ...
        <noscript><amp-iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MBB945"
                          height="0" width="0" amp-custom="display:none;visibility:hidden"></amp-iframe></noscript>
        <!-- End Google Tag Manager (noscript) -->
    <?php } else { ?>

    <!-- Google Tag Manager (noscript) -->
    <noscript><amp-iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TRP9H5"
                      height="0" width="0" style amp-custom="display:none;visibility:hidden"></amp-iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
    <?php } ?>
                        ...
                        <div id="top-links" class="nav col-sm-12">
                            <ul class="list-inline pull-right">
                               ...
                               <!-- <li class="sor">
                                    ...
                                    <?php } }else{ ?>
                                                <li><a href="<?php echo $manufacturer_link; ?>"><i class="fa fa-money"></i>&nbsp;<span class="hidden-xs hidden-sm hidden-md"><?php echo $manufacturer; ?></span> </a> </li>
                                    <?php } ?>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <?php if($logged){ ?>
                                        <a id="topbar-login" href="<?php echo $link; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle <?php echo $class; ?>" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo " ".$cust_name; ?></span><span class=""></span></a>
                                            <ul class="dropdown-menu dropdown-menu-right">
                                               ...
                                               <!--  <li><a href="<?php echo $order; ?>"><?php echo $text_order; ?></a></li> -->
                                                ...
                                                <li><a id="topbar-login"  href="<?php //echo $login; ?>"><?php //echo $text_login; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                            <?php }else{ ?>
                        ...
                        <div class="col-sm-12">
                            <div class="row sticky home_width_adjustment">
                                ...
                                <div class="col-sm-10">
                                        ...
                                        <a href="#" id="store_switch"><?php if (isset($this->session->data['custom_store'])) { ?>
                        ...
                        <div class="container-fluid home_width_adjustment">
                            <div class="collapse navbar-collapse navbar-ex1-collapse nopadding" id="menu-wrapper">
                                ...
                                <ul class="navbar-nav menu">
                                    ...
                                    <?php } else { ?>
                                    <li><a href="<?php echo $category['href']; ?>" id="wsb-nav-<?php echo $category['name_for_id']; ?>"><?php echo $category['name']; ?></a></li>
                                    <?php } ?>
                                    <?php } ?>
                                    <?php }else{ ?>
