...
<input type="hidden" value="<?php echo $this->session->data['ctoken']; ?>" name="ctoken" id="ctoken" />
    ...
    <div class="container-fluid margin_top_header">
        ...
        <?php } ?>
	<div class="row">
        <div class="cart_full_box" id="cart_full_box" style="margin-right: 5px;">
            ...
            <div class="col-sm-3 order_summary skeleton" style="margin-top:1%;"></div>
        </div>
    </div>
    </div>
        ...
        <div class="modal-dialog" style="z-index: 1050;">
            <div class="modal-content">
                <div class="modal-header address_popup_head">
                    ...
                    <h4 class="modal-title" id="address_popup_header">Add New Address</h4>
                </div>
    ...
    <div class="modal fade add_new_address" id="add_telephone" role="dialog">
        <div class="modal-dialog" style="z-index: 1050;width: 40%">
            <div class="modal-content">
                <div class="modal-header address_popup_head">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Please provide your mobile number</h4>
                </div>
                <div class="modal-body" id="address_popup" style="min-height: 100px;">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="select_set_box" style="margin-left: 15px;padding: 3px;margin-top: 0px;width: 90%;" minlength="6" maxlength="32" id="input_telephone" />
                        <div id="error_telephone" style="color: red;margin-left: 13px;"></div>
                    </div>
                    <div class="col-sm-4">
                        <button class="btn deliver_btn" style="margin-top: 0px;" id="submit_telephone">Submit</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="alert_popup" class="modal fade" role="dialog">
        <div class="modal-dialog" style="top:20%;width:50%;z-index: 1050;">
...
<div class="modal fade" id="help_popup_section" role="dialog">
    <div class="modal-dialog" style="top:20%;z-index: 1050;width:35%;">
        <div class="modal-content">
            ...
            <div class="modal-body help_popup_body">
                <div class="form-group help_popup_request">
                    <div class="call_back_input" id="call_back_input">
                        <input id="phone_number" class="input_phone_number" placeholder="Phone Number" type="text">
                        <button type="button" class="btn deliver_btn btn_call_me" id="btn_call_me" data-role="none">Call Me</button>
...
<link href="catalog/view/theme/default/css/flags.css" rel="stylesheet"/>
...
<script src="catalog/view/theme/default/javascript/sticky-kit.js"></script>
<script src="catalog/view/theme/default/javascript/jquery.placeholder.label.js"></script>
<link href="catalog/view/theme/default/css/skeleton.css" rel="stylesheet"/>
...
<script>
    ...
    $(function() {
        return $("#checkoutBlock").stick_in_parent({
    ...
    ReactDOM.render(React.createElement(Checkout, {cart:cart_data,customer:cart_data.customer, shipping_addresses:shipping_addresses, payment_data:payment_data, language:language, international_store:international_store,countries:countries,tab:tab,neo_credit_user_credit_limit:neo_credit_user_credit_limit,rbl_credit_user_credit_limit:rbl_credit_user_credit_limit,RBL_ORDER_LIMIT:RBL_ORDER_LIMIT, text_rbl_limit_error:text_rbl_limit_error, cod_available_limit:cod_available_limit,cod_advance_amount_limit:cod_advance_amount_limit},null ), document.getElementById('cart_full_box'));
