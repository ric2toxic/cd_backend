...
<div style="overflow-x:auto">
    <table class="table table-bordered">
      ...
      <tr>
        <td class="product-image" data-th="Image"><?php if ($product['thumb']) { ?>
          <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
          <?php } ?></td>
        <td class="product-details"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a><br/> <span style="font-size:11px;"><?php echo $text_product_code . $product['model']; ?></span><br/> <span style="font-size:11px;"><?php echo $product['set_description']; ?></span>
      ...
      <tr>
        ...
        <td class="text-left" colspan="2"> <?php echo($total_sets . " " . $column_quantity); ?><?php echo " = ".($total_pieces . " " . $pcs); ?></td>
      ...
      <tr>
        ...
        <td class="text-left" style="font-size:13px; font-weight: 500" colspan="2"><?php echo $total['text']; ?></td>
        <?php } else { ?>
        <td class="text-left" colspan="2"><?php echo $total['text']; ?></td>
        <?php } ?>
      </tr>
      <?php } else {
             ...
             ?>
      <tr>
        <td colspan="2" class="text-right"><strong><?php echo $text_cst; ?>:</strong></td>
        <td class="text-left" colspan="2"><?php echo $cst; ?></td>
      </tr>
      <tr>
        <td colspan="2" class="text-right"><strong><?php echo $text_tax_refund; ?>:</strong></td>
        <td class="text-left" colspan="2"><?php echo $tax_refund; ?></td>
      </tr>
      <?php } else{
            ?>
      <tr>
