<form class="form-horizontal">
  ...
  <?php if ($addresses) { ?>
  <div class="radio col-md-9 use_shipping_address">
    <div>
  ...
  <div class="radio col-md-3 new_button_address_link  new_address">
    <div>
  ...
  <div id="shipping-existing">
    ...
    <div class="row">
      ...
      ?>
      <div class="col-md-4 shipment_address<?php echo $address['address_id']; ?>" >
        <div class="address_block shipment_address <?php echo $addClass; ?> <?php //echo $cssclass; ?>" data-address-id="<?php echo $address['address_id']; ?>" hidden-city-value="<?php echo $address['city']; ?>" hidden-address1-value="<?php echo $address['address_1']; ?>">
  ...
  <div class="buttons">
    ...
    <div class="pull-right">
      <div class="continue shipment_continue_collapse" data-address-id="<?php echo $address_value; ?>" hidden-city-value="<?php echo $hidden_city_value; ?>" hidden-address1-value="<?php echo $hidden_address1_value;?>"><span><?php echo $button_continue; ?></span></div>
    </div>
  </div>
  <?php } ?>
  <br />
...
<script type="text/javascript"><!--
  ...
  $('div.shipping_address').on('click', function() {
    if ($(this).attr('data-type') == 'new') {
      ...
      $('div.new_address').removeClass('new_button_address_link col-md-3');
      ...
      $('div.existing').html('<span class="use_saved_title">Use Saved Address</span> <span class="smallhead"> (We will deliver your order here)</span> </div>');
      $('div.new').addClass('button_address_link');
      $('div.new_address').addClass('new_button_address_link col-md-3');
 ...
 /* $('div.shipment_address').on('click', function() {
  ...
  $('div.shipment_address').on('click', function() {
    ...
    $('div.shipment_continue_collapse').attr('hidden-city-value',$(this).attr('hidden-city-value'));
    $('div.shipment_continue_collapse').attr('hidden-address1-value',$(this).attr('hidden-address1-value'));
    $('div.shipment_address').removeClass('selected_address');
    $(this).addClass('selected_address');
  });
  ...
  $('div.shipment_continue_collapse').on('click', function() {
    if($(this).attr('data-address-id')!=''){
      if($(this).attr('hidden-city-value')!='' && $(this).attr('hidden-address1-value')!=''){
        ...
        alert('Please select your another shipping address!');
      }
    }else{
...
<script type="text/javascript"><!--
  ...
  <?php }else{ ?>
    $('#collapse-shipping-address input[name=\'country_id\']').on('change', function() {
