...
<div class="clearfix"></div>
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php echo $content_top; ?>
      ...
      <label class="dropshipper_heading1"> 
         ...
         <div class="account_referral_box">
           <?php /* ?>
            ...
            <div class="width_fifty col-sm-6">
              <span class="referral_text"><?php echo $text_credit_balance; ?> : <i class="fa fa-inr" style="font-size: 12px;"></i>
              <strong><?php echo $amount; ?></strong></span><br />
      ...
      <div class="orders_table_box" style="min-height:400px;">
