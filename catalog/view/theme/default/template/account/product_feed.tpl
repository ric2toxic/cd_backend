...
<div class="container-fluid width_fix">
    ...
    <div class="row my_account"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?> box_shadow_none">
            ...
            <hr>
            <div>
                Product feed download link with last update date.
            </div> 
            <div class="col-sm-12 nopadding">
                <br/>
                <div class="col-sm-3 nopadding">
                    <a id="product_feed" class="hidden-xs btn btn-block btn-lg dropdown-toggle csv_btn product_feed">
                        <span id="cart-total"> Download CSV </span>
                    </a>
                </div>
                <div class="clearfix"></div>
                <?php if(isset($modify_date_time)) { ?>
                    <div class="update_date_csv">Last update date:<span> <?php echo $modify_date_time; ?> </span></div>
                <?php } ?>
            </div>
            <br/>
            <div class="csv_contant">
                <p>
                    <br>
                    API<br/>
                    Check the stock of a product real time.
                    <br/>
                    Before accepting the order on your website we recommend that your system calls this api to check availability status of the product.
                    <br/>
                    Endpoint URL:<a class="csv_teg" href="http://www.wholesalebox.in/index.php?route=feed/feed/checkStock"> http://www.wholesalebox.in/index.php?route=feed/feed/checkStock </a>
                </p>
                <p>
                    <br>
                    Input Parameters:
                    <br/>
                    1.Token - your access token is <b>a5a954e23x57d100</b>
                    <br/>
                    2.Model - you would find the model number of product in sheet
                </p>
                <p>
                    <br>
                    For Example:
                    <br/>
                    URL: http://www.wholesalebox.in/index.php?route=feed/feed/checkStock&token=xxxyyyzzz&model=abcd
                </p>
                <div class="clearfix"></div>
                <div class="col-sm-12 csv_info">
                    <ul> <li>For Help:</li>
                         <li><a href=""><label><i class="fa fa-phone" aria-hidden="true"></i></label> (+91) 141 - 4049163</a></li>
                         <li><a href=""><label><i class="fa fa-whatsapp whatsapp_green" aria-hidden="true"></i></label>  +919116134795</a></li>
                         <li><a href=""><label><i class="fa fa-whatsapp whatsapp_green" aria-hidden="true"></i></label> +919982330835</a></li>
                         <li><a href=""><label><i class="fa fa-envelope" aria-hidden="true"></i></label> info@wholesalebox.in</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".product_feed").click(function(){
        $('a.product_feed').attr({target: '_blank', href  : 'index.php?route=account/download/productFeed&ctoken=<?php echo $ctoken; ?>'});
    });
  });
</script>
<script type="text/javascript">
