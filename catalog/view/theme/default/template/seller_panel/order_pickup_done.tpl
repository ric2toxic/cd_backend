...
<div id="page-wrapper">
  ...
  <div class="col-sm-12">
    <ul class="nav nav-tabs profile_tebination">
      ...
      <li class="active">
        <a href="<?php echo $pickup_done_link; ?>">
    ...
    <div id="order_pockupdone_filters" class="collapse in" aria-expanded="true" style="">
        <div class="order_pockupdone_filters_section">
            ...
            <div class="form-inline text-right">
                ...
                $allchecked = '';
                $withoutsor = '';
                if (isset($this->request->get['filter_sor_record']) && $this->request->get['filter_sor_record']=='onlysor') {
                    $sorchecked = 'checked="checked"';
                }else if (isset($this->request->get['filter_sor_record']) && $this->request->get['filter_sor_record']=='withoutsor') {
                    $withoutsor = 'checked="checked"';
                }else{
                    $allchecked = 'checked="checked"';
                }
                ?>
                <div class="pull-left filter_sor_listing" >
                    <input type="radio" <?php echo $allchecked;?> name="filter_listing" value="all"><lable>All Orders</lable>
                    <input type="radio" <?php echo $withoutsor;?> name="filter_listing" value="withoutsor"><lable>Show Online Orders</lable>
                    <input type="radio" <?php echo $sorchecked;?> name="filter_listing" value="onlysor"><lable>SOR Order</lable>
                </div>
                ...
                <div class="panel-body" id="accordion">
                    <table class="orders_table">
                        <thead>
                            <tr>
                                ...
                                <td>
                                    <table width="100%">
                                        <tr>
                                            <td><?php echo $column_invoice_no;?></td>
                                            <td><?php echo $column_invoice_amount;?></td>
                                            <td><?php echo $column_invoice_date;?></td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <tbody>
                            ...
                            <??>
                                <?php
                                //pr($order_pickup_data);
                                 foreach($order_pickup_data as $pickup_values) { 
                                    
                                    ?>
                                <tr>
                                    <td width="5%"><a data-target="#<?php echo $pickup_values['suborder_id']; ?>" data-toggle="modal"><?php echo $pickup_values['order_no']; ?></a>
                                    ...
                                    <td width="15%">
                                        <table width="100%">
                                            ...
                                            if (!empty($pickup_values['seller_invoices']) && count($pickup_values['seller_invoices'])>0) {
                                                
                                            
                                             foreach($pickup_values['seller_invoices'] as $inv_no_values ) { ?>
                                            <tr>
                                                <td><?php echo $inv_no_values['seller_invoice_prefix'].''.$inv_no_values['seller_invoice_no']; ?>  </td> 
                                                <td><?php echo number_format($inv_no_values['seller_inv_amount'],2); ?>  </td> 
                                                <td><?php echo $inv_no_values['date_added']; ?>  </td> 
                                            </tr>
                                            <?php
                                             }
                                         }else{
                                            echo '<tr>';
                                              if (isset($pickup_values['sor_invoice_no'])) {
                                                 ...
                                                 echo '<td style="width:116px;">'.$pickup_values['sor_invoice_no'].'</td>';
                                                 echo '<td style="width:115px;"> </td>';
                                                 echo '<td>'.date('Y-m-d',strtotime($pickup_values['sor_invoice_date'])).'</td>';
                                    ...
                                    <td width="5%"><?php echo $pickup_values['net_payable_amount']; ?></td>
                                    <td class="paid_tooltip" data-order-no="<?php echo $pickup_values['order_no'];?>" data-paid-data='<?php echo html_entity_decode($pickup_values["payment_tool_tip"]); ?>'>
                                        
                                        <span class="tooltip_li paid_tooltip_box" id="tooltip_li_<?php echo $pickup_values['order_no'];?>" ><?php echo $pickup_values['trxn_done']; ?></span>
                                    </td>
                                    <td>
                                    <?php
                                     if (!empty($pickup_values['seller_invoices']) && count($pickup_values['seller_invoices'])) {
                                     ?>
                                        <div class="dropdown">
                                            <button class="btn filter_search_btn dropdown-toggle select_inv_dbt_pdf" type="button" data-toggle="dropdown">--Select--
                                            </button>
                                            <ul class="dropdown-menu Invoices_download">
                                                <li><a href="javascript:void(0);"><b>Invoices</b></a>
                                                    <ul>
                                                        <?php 
                                                                    if($pickup_values['seller_invoice_link']) { 
                                                                        foreach($pickup_values['seller_invoice_link'] as $slr_inv_no_key => $inv_dwnlod_link){

                                                              ?>
                                                        <li>
                                                                <a href="<?php echo $inv_dwnlod_link['url']; ?>" 
                                                                    class="invoice_icon" 
                                                                    title="View Invoice">
                                                                    <?php echo $inv_dwnlod_link['label']; ?>
                                                                </a>
                                                        </li>
                                                            <?php } } ?>
                                                ...
                                                <?php if( !empty( $pickup_values['debit_note_link'] ) ) { ?>
                                                <li><a href="javascript:void(0);"><b>Debit Notes</b></a>
                                                    <ul>
                                                        <?php foreach( $pickup_values['debit_note_link'] as $debit_keys => $debit_values ){  ?>
                                                        <li>
                                                            <a href="<?php echo $debit_values['url']; ?>" class="invoice_icon" title="Download Debit Note"><?php echo $debit_values['label']; ?></a>
                                                        </li>
                                                        <?php } ?>
                                                    </ul>
                                                </li>                                   
             ...
             if( !empty($order_pickup_data ) ) { ?>
                <?php
                 foreach($order_pickup_data as $pickup_values) { 
                    $showsor = 1;
                    ?>
                    <div id="<?php echo $pickup_values['suborder_id']; ?>" class="modal fade order_popup_section" role="dialog">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                  ...
                                  <div class="title_right popup_tight_title">
                                    ...
                                    <span class="oredr_right">Order Processing Date : <?php echo $pickup_values['order_date_added'];?></span>
                                  </div>
                                  ...
                                  <div role="tabpanel">
                                    <ul class="nav nav-tabs profile_tebination subtable_box" role="tablist">
                                        ...
                                        if (!empty($pickup_values['sllr_invc_genrted'])) {
                                            ...
                                            foreach ($pickup_values['sllr_invc_genrted'] as $key => $value) {
                                             ?>
                                             <li class="<?php if($si==1){echo 'active';}?>">
                                                <a href="#seller_invoices_tab_<?php echo $value['invoice_no'];?>" aria-controls="seller_invoices" role="tab" data-toggle="tab"><?php echo $value['invoice_no'];?></a>
                                            </li>
                                             <?php 
                                             $si++;
                                            }
                                        ...
                                        ?>
                                    <?php if (!empty($pickup_values['seller_sor_product'])) { ?>
                                    <li class="<?php if($si==1){echo 'active';}?>">
                                        <a href="#seller_invoices_tab_sor_<?php echo $pickup_values['suborder_id'];?>" aria-controls="seller_invoicess" role="tab" data-toggle="tab">SOR Order</a>
                                    </li>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <div class="tab-content popup_content_table">
                                         <?php
                                        if (!empty($pickup_values['sllr_invc_genrted']) && count($pickup_values['sllr_invc_genrted'])) {
                                           
                                            foreach ($pickup_values['sllr_invc_genrted'] as $key => $value) {
                                             ?>
                                             <div class="tab-pane <?php if($ti==1){echo 'active';}?>" id="seller_invoices_tab_<?php echo $value['invoice_no'];?>">
                                             
                                                <div class="tab_order_info_invoice" style="display: block; height: 41px;">
                                                    <div class="pull-left">
                                                        Invoice No. <b><?php echo $value['invoice_no'];?></b>
                                                    </div>
                                                    <div class="pull-right">
                                                        <a class="btn btn-primary btn-sm invoice_icon_btn" href="<?php echo $value['invoice_pdf'];?>">Download Invoice</a>
                                                    </div>
                                                </div>    
                                                <div class="detail">
                                                    <table width="100%" class="order_detail_popup_table table">
                                                        ...
                                                        <tbody>
                                                            <?php if ( !empty($value['products_data']) ) { 
                                                                    $total_amount = 0;
                                                                    foreach( $value['products_data'] as $suborder_key => $suborders_product_data ) {
                                        ...
                                        ?>
                                        <?php if (!empty($pickup_values['seller_sor_product'])) { ?>
                                            <div class="tab-pane <?php if($showsor==1){echo 'active';}?>" id="seller_invoices_tab_sor_<?php echo $pickup_values['suborder_id'];?>">
                                                    ...
                                                    <table width="100%" class="order_detail_popup_table table">
                                                        ...
                                                        <tbody>
                                                            <?php if ( !empty($pickup_values['seller_sor_product']) ) { 
                                                                    ...
                                                                    $total_amount = 0;
                                                                    foreach( $pickup_values['seller_sor_product'] as $suborder_key => $suborders_product_data ) {
                                                                        foreach($suborders_product_data as $product_details){
                                                            ?>
                                                                <tr>
                                                                    <td>
...
$('#download_pickup_done_report').click(function(){
    var url = "index.php?route=seller_panel/account-order/getPickupOrderDone"; 
