            ...
            <div class="signup-form-wrapper">
                ...
                <div class="row contentblock">
                    <div class="col-md-7">
                        ...
                        <p>
                            Please email the following documents on <a href="mailto:accounts@wholesalebox.in">accounts@wholesalebox.in</a> to enable us to approve your seller account through which you can wholesale on this platform WHOLESALEBOX:
                        </p>
                        <ol>
                            <li>
                             Your PAN Card copy
                        ...
                        <p>
                        If you have ANY questions about seller registration, you can call on <a href="tel:+919116134791" >+91 9116134791</a>.
                        </p>
                        <p>
