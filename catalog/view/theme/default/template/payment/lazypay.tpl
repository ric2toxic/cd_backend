...
<input name="transaction_id" id="transaction_id" type="hidden" value="<?php echo $transaction_id;?>" />
...
<input name="customParams" id="customParams" type="hidden" value="" />
    ...
    <?php if(!empty($success) ) { ?>
        ...
        <div class="buttons">
            ...
            <p>
               <?php echo sprintf($text_charge, $transaction_amount); ?>
            </p>

            <p><?php echo $text_otp_msg; ?></p>

                <div class="pullleft">
                    <input name="otp" id="otp" type="text" value="" class="form-control" placeholder="Enter OTP" style="width:150px;" />
                    <div class="otp_main">
                ...
                <div class="pull-right">
                    <button id="button-confirm" class="btn btn-primary button-confirm" type="button">CONFIRM ORDER</button>
                </div>
...
$('#button-confirm').on('click', function() {
    ...
    if( $('#otp').val().trim() == '' ) {
        ...
        $('#alert_body').html('Enter OTP number send on your mobile number from Lazypay');
          $('#alert_popup').modal({
              backdrop: 'static',
              keyboard: false
          });
...
function showTimer()
{
    ...
    var interval = setInterval(function() {
      ...
      if (minutes < 0) {
         ...
         var vlink = '<a href="javascript:void(0)">Click here to Resend OTP</a>'; 
         $('#vlink').html(vlink);
       } 
