          ...
          <div class="container">
              <div class="col-sm-12">
                <div class="col-sm-6 left_side"> 
                   ...
                   <div class="col-sm-6 nopadding right_padding_adjust">
                     <p class="right_hand">
                   ...
                   <div class="row logo_app_link">
                     <div class="col-sm-6 nopadding"><a href="https://www.wholesalebox.in"><img style="width: 200px;" src="https://d36qiqd7gl7e25.cloudfront.net/img/catalog/rsz_wsb_tmp_logo_286.png"></a></div>
                    <div class="col-sm-6 nopadding right_padding_adjust">
                ...
                <div class="middle_shadow_line"><img src="https://cdnimages.net/maintenance/middle_shadow_line.png"></div>
