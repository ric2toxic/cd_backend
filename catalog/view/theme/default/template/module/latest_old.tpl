...
<div class="<?php echo $class_latest; ?>" style="height: 300px; background-color: white">
    <div class="card_box_flat nopadding hidden-xs list_craousel" id="LatestProducts" style="height: 300px;">
