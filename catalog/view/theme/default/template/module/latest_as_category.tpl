<div class="col-sm-12 categories_on_home">
    <h4><?php echo $heading_title; ?></h4><a href="<?php echo $href; ?>"><input type="button" class="category_view_all" value="View All" /></a>
</div>
<div class="home_categories">

    <div class="row card_box_flat nopadding hidden-xs list_craousel LatestCategory LatestCategory_<?php echo $category_id; ?>">
