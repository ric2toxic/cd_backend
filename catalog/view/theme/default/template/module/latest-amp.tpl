<?php if(isset($discount_shipping_popup) && $discount_shipping_popup == 0 ){
          $class_latest = " ";
          $class_image  = "display:none;";
         }else{
          $class_latest = "col-sm-12 nopadding";
          $class_image  = "display:block;";
     } ?>

<div class="latest_container">
    <h3 class="text_line"><span><?php echo $heading_title; ?></h3>
    
<div class="home_categories">
    <amp-carousel width=auto class="<?php echo $class_latest; ?>">
  <?php foreach ($products as $product) { ?>

    <div class='home_categories_product'>

    <amp-img srcset="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" width="<?php echo $product['amp_width']?>" height="<?php echo $product['amp_height']?>" class="img-responsive"></amp-img>
      ...
      <h6><a href="<?php echo $product['href']; ?>"><?php echo mb_strimwidth($product['name'], 0, 50, "..."); ?></a></h6>
