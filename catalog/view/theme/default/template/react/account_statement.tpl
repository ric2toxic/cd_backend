...
<script src="catalog/view/theme/default/javascript/bootstrap-multiselect.js" type="text/javascript"></script>
<script src="<?php echo UPLOAD_CONTENT_URL_SSL.COMMON_REACT_JS; ?>"></script>
<!-- home jsx -->
<script src="catalog/view/theme/default/javascript/account_statement.js?v=2.3" type="text/javascript"></script>
...
ReactDOM.render(React.createElement(AccountStatementLayout, { myaccount_language:myaccount_language, header_language:header_language, footer_language:footer_language, international_store:international_store, custom_store:custom_store, custom_store_val:custom_store_val, logout_url:logout_url, popular_tags:popular_tags},null ), document.getElementById('home_page')); 
