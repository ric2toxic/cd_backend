...
<!-- home jsx -->
<script src="catalog/view/theme/default/javascript/bank_details.js?v=0.3" type="text/javascript"></script>
...
ReactDOM.render(React.createElement(BankLayout, { myaccount_language:myaccount_language, header_language:header_language, footer_language:footer_language, international_store:international_store, custom_store:custom_store, custom_store_val:custom_store_val, logout_url:logout_url},null ), document.getElementById('home_page')); 
