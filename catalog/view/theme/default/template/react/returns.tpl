...
<!-- home jsx -->
<script src="catalog/view/theme/default/javascript/returns.js?v=0.3" type="text/javascript"></script>
...
var master_return_id    = <?php echo $master_return_id; ?>;
...
ReactDOM.render(React.createElement(ReturnsLayout, { myaccount_language:myaccount_language, header_language:header_language, footer_language:footer_language, international_store:international_store, custom_store:custom_store, custom_store_val:custom_store_val, logout_url:logout_url,master_return_id:master_return_id,order_no:order_no},null ), document.getElementById('home_page')); 
