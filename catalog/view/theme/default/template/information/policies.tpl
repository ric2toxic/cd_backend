...
.short_description.active{display: block;}
.pull-right
{
  float: right;
}
...
.icon_description
{
  ...
  width: 100%;
  padding: 1px;
  background: linear-gradient(to right, #31FFF5, #005FA3);
  margin:10px 0px;
}
.inner_body
{
 ...
 <div class="container-fluid">
  ...
  <div class="col-sm-3">
    ...
    <?php foreach($informations as $information) { ?>
      <a href="javascript:;" id="tab_<?php echo $information['information_id'] ?>" onclick="tab_change(<?php echo $information['information_id'] ?>);" class="<?php echo $information['class'] ?>"><?php echo $information['title'] ?> <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a>
    <?php } ?>  
    </div>
    <div class="youtube_link"><iframe width="100%" src="https://www.youtube.com/embed/Hztk9eCP15k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
  </div>
  <div class="col-sm-9">
    <div class="main">

    <?php foreach($informations as $information) { ?>
    <div id="<?php echo $information['information_id'] ?>" class="short_description <?php echo $information['class'] ?>">
     <div class="row">
       <div class="col-sm-12">
      <?php echo $information['short_description']; ?>
        </div> 
         <div class="read_more">
           <a href="<?php echo $information['href']; ?>">View More Information</a>
         </div>
    </div>  
...
function tab_change(information_id)
{
  $(".sidenav a").removeClass("active");
  $("#tab_"+information_id).addClass("active");
  $('.short_description').hide(300); 
  $('#'+information_id).show(300);
}
</script>
</body>
