 class Review extends React.Component {
   ...
   render() {
         ...
         return(<div className="Customer_review_outer">
          <div className="">
          <div className="container">
            <div className="customer_heading"><h3>What our Customers say?</h3></div>
            <div className="border_bottom"><span></span></div>
          <div className="Customer_review">
            <div className="">          
          <div id="myCarouselReview" className="carousel slide" data-ride="carousel">
            <div className="carousel-inner">
              <div className="item active">                
                  
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"nirajharlalka.jpg"} />
                      </div>
                    ...
                    <div className="col-sm-4 col-md-4 dotted_border">
                     
                      <div className="profile_img"><img src={cdn_url+"haseebmohammad.jpg"} />
                      </div>
                      <div className="Profile_review">
                    ...
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"arjunkalawat.jpg"} />
                      </div>
                      <div className="Profile_review">
              ...
              <div className="item">                
                    ...
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"karthikn.jpg"} />
                      </div>
                      <div className="Profile_review">
                    ...
                    <div className="col-sm-4 col-md-4 dotted_border">
                      <div className="profile_img"><img src={cdn_url+"no_image.jpg"} />
                      </div>
                      <div className="Profile_review">
                    ...
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"mayankverma.jpg"} />
                      </div>
                      <div className="Profile_review">
              ...
              <div className="item">                
                    ...
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"kalyan.jpg"} />
                      </div>
                      <div className="Profile_review">
                    ...
                    <div className="col-sm-4 col-md-4 dotted_border">
                      <div className="profile_img"><img src={cdn_url+"Jain.jpg"} />
                      </div>
                      <div className="Profile_review">
                    ...
                    <div className="col-sm-4 col-md-4">
                      <div className="profile_img"><img src={cdn_url+"nibedita.jpg"} />
                      </div>
                      <div className="Profile_review">
              ...
              <a className="left_arrow pull-left" href="#myCarouselReview" data-slide="prev">
                <span className="fa fa-arrow-left"></span>
              </a>
              <a className="right_arrow pull-right" href="#myCarouselReview" data-slide="next">
