  ...
  if($('#carousel-category_prev_'+id).attr('data') == 0)
  {
   ...
   $('#carousel-category_'+id).carousel('next');
    ...
    var imageItem = this.props.product.images.map(function(image, index) {
        return (<li><ImageItem key={index} image={image} /></li>);
      })
   ...
   function createMarkup(html) {
    ...
    return (
           ...
           <div className={this.props.list_page ? 'c-product-card new_ outofstock installments_ mastercard c-product-card_js_inited c-product-card_view_grid c-product-list__item' :
                      ...
                      <div className="c-product-card__img-placeholder">
                          <a href={this.props.product.href} className="c-product-card__img-placeholder-inner">
                            <span className="c-img-lazy  c-product-card__img  c-img-lazy_js_inited c-img-lazy_loaded">
                              <SlideImg width={this.props.product.width} height={this.props.product.height} class="largeImage c-img-lazy__img" src={this.props.product.image} main_image={this.props.product.original} />
                            </span>
                         </a>
                      </div>
                      ...
                      {image_count > 1 ?  
                         image_count > 5 ?
                      <div className="c-product-card__gallery">
                     ...
                     { this.props.product.exp_dispatch_days > 0 ?
                      ...
                      <div className="c-product-card__description">
                        <a data-placement="top"  data-toggle="popover"  data-trigger="hover" data-content={this.props.product.full_name} href={this.props.product.href}>{this.props.product.full_name} </a>
                       </div>
                 
                  
                 <div className="blue_bg">
                   {this.props.product.is_sor_enabled ?
                   <div data-placement="top"  data-toggle="popover"  data-trigger="hover" data-content={this.props.product.sor_enabled_text}>
                   <img className="round_box" src={cdn_url+"sor_box.png"} />
               ...
               <div className="product_card_description">
                 <span><a href="javascript:;" data-placement="top"  data-toggle="popover"  data-trigger="hover" data-content={this.props.product.set_description}> {this.props.product.set_description} </a>
                 <br />  </span>
              </div>
      </div>
      )
