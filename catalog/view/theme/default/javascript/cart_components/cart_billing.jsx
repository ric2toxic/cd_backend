...
class CartBilling extends React.Component{
    ...
    updateAddress(address){
        ...
        if(invalid_address == true){
            ...
            this.props.updateBillingAddress(address);
        }
    ...
    render(){
        return(
            <div>
                ...
                {jQuery.isEmptyObject(this.props.shipping_addresses)?(
                    ...
                    <div>
						<div className="col-sm-12 checkout_add_address_button" id="add_address_div" >
                            <div><span className="cart_data_heading">{this.props.language.text_select_billing_address}</span></div>
                                     ...
                                     if (address.address_id == this.props.customer.address_id) {
                                      ...
                                      return(
                                        <div className="col-sm-4 cart_table" key={address.address_id}>
                                            <div className="address_penal_billing" id={'billing_'+address.address_id} style={{margin:'5px',padding:'4%'}} onClick={this.updateAddress.bind(this,address)} data-toggle="tooltip" title={address.address_1+", "+address.address_2+", "+address.address_telephone.join(", ")+", "+address.city+" "+address.zone+", "+address.postcode}>
                                                <ul>
                                                ...
                                                <div className="selected_address">
                                                    ...
                                                    <div className="clearfix"></div>
                                                    <div className="deliver_address_text">BILLING TO THIS ADDRESS</div>
                                                </div>
                                            </div>
                                        </div>
                                      );
                ...
                <div className="col-sm-12 cart_table" style={{display:'none'}} id="select_billing_button">
