...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 checkout_steps">
            <div class="checkout_step1" id="checkout_step1">
                <span class="pull-left"><?php echo $text_checkout_payment_address; ?></span>
                <span class="pull-right"><?php echo $steps_one; ?></span>
            </div>
            <div class="checkout_step2" id="checkout_step2">
                <span class="pull-left"><?php echo $text_checkout_payment_method; ?></span>
                <span class="pull-right"><?php echo $steps_two; ?></span>
            </div>
            <div class="checkout_step3" id="checkout_step3">
                <span class="pull-left"><?php echo $text_checkout_confirm; ?></span>
                <span class="pull-right"><?php echo $steps_three; ?></span>
            </div>
        </div>
    </div>
...
<script type="text/javascript"><!--
    ...
    <?php } else { ?>
        $(document).ready(function() {
            $('.checkout_steps').show();
            $.ajax({
                url: 'index.php?route=checkout/payment_address&ajax=true',
                dataType: 'html',
                success: function(html) {
    ...
    $(document).delegate('#button-payment-address', 'click', function() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            beforeSend: function() {
                $('.payment_address_continue').button('loading');
                $('.collapse-payment-method .panel-body').hide();
                $('.collapse-payment-method').addClass('checkout_loading');
            },
            success: function(json) {
                ...
                <?php if ($shipping_required) { ?>
                        if((existing_check_ship_same_value==0) || payment_check_ship_same_value==0) {
                            ...
                            $.ajax({
                                ...
                                dataType: 'html',
                                beforeSend: function() {
                                    $('.shipment_continue_collapse').button('loading');
                                    $('.collapse-shipping-address .panel-body').hide();
                                    $('.collapse-shipping-address').addClass('checkout_loading');
                                },
                                success: function(html) {
                                ...
                                complete: function() {
                                    $('.shipment_continue_collapse').button('reset');
                                    $('.collapse-shipping-address').removeClass('checkout_loading');
                                    $('.collapse-shipping-address .panel-body').show();
                                }
                            });
                        }else{
                            $('.account_billing_detail').hide();
            ...
            complete: function() {
                $('.payment_address_continue').button('reset');
                $('.collapse-payment-method').removeClass('checkout_loading');
                $('.collapse-payment-method .panel-body').show();
            },
        });
    });
    ...
    $(document).delegate('#button-payment-method', 'click', function() {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.collapse-checkout-confirm .panel-body').hide();
                $('.collapse-checkout-confirm').addClass('checkout_loading');
            },
            success: function(json) {
                $('.alert, .text-danger').remove();
            ...
            complete: function() {
                ...
                $('.collapse-checkout-confirm').removeClass('checkout_loading');
                $('.collapse-checkout-confirm .panel-body').show();
            }
        });
    });
    $(document).ready(function(){
