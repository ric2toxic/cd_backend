<div class="col-sm-12">
<div class="shipping-slabs card_box_flat">
	<?php /* ?> <table  class="table table-bordered">
		<thead>
		<tr>
			<th colspan="2">
				Estimated Shipping cost for Surface Courier( 6-9 days )
			</th>
		</tr>
		</thead>
		<tbody>
		<tr>
			<td class="text-right"><strong>2 to 15 KG</strong></td>
			<td class="text-right">Rs. 30 Per KG</td>
		</tr>
		<tr>
			<td class="text-right"><strong>16 to 30 KG</strong></td>
			<td class="text-right">Rs. 25 Per KG</td>
		</tr>
		<tr>
			<td class="text-right"><strong>31 to 45 KG</strong></td>
			<td class="text-right">Rs. 18 Per KG</td>
		</tr>
		<tr>
			<td class="text-right"><strong>46+ KG</strong></td>
			<td class="text-right">Rs. 12 Per KG</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				*Rates applicable only if TIN number and road permit is provided,
				Else a flat rate of Rs 30 will be charged
				</php */ ?>
				...
				<script type="text/javascript"><!--
					$('#button-quote').on('click', function() {
						var cartlimitcross = $("#cartlimitcross").val();

						$.ajax({
							url: 'index.php?route=checkout/shipping/quote',
							type: 'post',
							data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
							// data: 'country_id=' + 99 + '&zone_id=' + 1501 + '&postcode='+'&cartlimitcross='+cartlimitcross,
							dataType: 'json',
							beforeSend: function() {
