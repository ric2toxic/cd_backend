...
<head>
    ...
    <link href="image/css/seller_panel/seller-panel-stylesheet.css?v=1" rel="stylesheet" media="screen" />

    <!-- Custom CSS -->
    <link href="image/css/seller_panel/sb-admin-2.css?v=1" rel="stylesheet">
    ...
    <div id="wrapper" >
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand sp-logo" href="<?php echo $account_dashboard; ?>"><img src="https://www.wholesalebox.in/image/catalog/rsz_wsb_tmp_logo_286.png"></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo $account_order;?>"><i class="fa fa-bar-chart-o fa-fw"></i> Sales</a>
                        ...
                        <li>
                            <a href="<?php echo $manage_inventory; ?>"><i class="fa fa-reply fa-fw"></i> Inventory </a>
                        </li>
                       <?php } ?>
