  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
        ...
        <div class="signup-form-wrapper">
            ...
            <div class="form-block-heading"><?php echo $ms_account_register_details; ?></div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-element-part">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="seller[name]" placeholder="<?php echo $entry_name; ?>" class="form-control name" />
                                </div>
                            </div>
                            <?php /* ?>
                            <div class="form-group required">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="seller[telephone]" placeholder="<?php echo $entry_telephone; ?>" class="form-control name" />
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" name="seller[email]" placeholder="<?php echo $entry_email; ?>" class="form-control email" />
                                </div>
                            </div>
