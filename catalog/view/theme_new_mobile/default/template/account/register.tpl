      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="checkbox" id="showWhatsAppNumber" value="WhatsApp Number" />
              <label for="showWhatsAppNumber"><?php echo $text_mob_pop;?></label>
            </div>
          </div>
          ...
          <div class="form-group" id="showWhatsAppNumberBox" style="display:none;">
            ...
            <div class="col-sm-10">
              <input type="tel" id="input-whatsapp-telephone" name="whatsapp_telephone" placeholder="ENTER YOUR WHATSAPP NUMBER" class="form-control email_width" />
            </div>
          </div>
