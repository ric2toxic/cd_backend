...
<div class="container">
  ...
  <div class="row account_page"><?php echo $column_left; ?>
    ...
    <div id="content"><?php echo $content_top; ?>
      <div class="well">
        <ul class="nav nav-tabs">
          <li class="active signin"><a href="#sign_in" class="common-form login_show" data-value="log_in">Log in</a></li>
        ...
        <div class="tab-content">
          ...
          <div id="sign_up" class="tab-pane fade">
            <form action="<?php echo $reg_action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="signupForm">
              <fieldset id="account">
        ...
        <div class="col-sm-6">
          <div class="well">
            ...
            <a href="index.php?route=account/register" class="btn btn-primary"><?php echo $button_continue; ?></a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            <h2><?php echo $text_returning_customer; ?></h2>
...
<script>
  ...
  /*$(document).ready(function(){
    ...
    $('.log_submit_button').click(function(e){
      flag = 0;
      //e.preventDefault();
      if($('.log_email').val()==''){
    ...
    $('.forget-email').val($('.log_email').val());
