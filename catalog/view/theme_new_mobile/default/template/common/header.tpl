...
<head>
    ...
    <link href="catalog/view/theme_new_mobile/default/css/bootstrap-tagsinput.css" type="text/css" rel="stylesheet" media="screen" />
    ...
    <script type="text/javascript" src="catalog/view/theme_new_mobile/default/javascript/jquery.placeholder.label.js">
    </script>
...
<div id="header-mobile" class="scrollspy">
        ...
        <div class="row">
            ...
            <div class="col-xs-1">
                ...
                <?php if ($logged) { ?>
                 ...
                 <?php } else { ?>
                    <a data-toggle="modal" id="wishlist-total" data-target="#login_verify_popup">
                    <i class="material-heart-custom heart"></i> 
                    </a> 
                <?php } ?>
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas" role="navigation">
       ...
       <!-- <li class="sor highlighted">
            ...
            <li class="highlighted" id="topbar-login"><a href="javascript:void(0)" onclick="logout()"><?php echo $text_logout; ?></a></li>
            <?php } else { ?>
            ...
            <!-- <li class="highlighted" id="topbar-signup"><a href="<?php echo $login; ?>"><?php echo $text_login_signup; ?></a></li> -->
            <?php } ?>
            <li>&nbsp;</li>
            <li>&nbsp;</li>
        </ul>
