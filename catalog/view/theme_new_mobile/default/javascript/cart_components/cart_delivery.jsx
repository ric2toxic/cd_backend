...
class CartDelivery extends React.Component{
    ...
    updateAddress(address){
        ...
        if(invalid_address == true){
            ...
            this.props.updateDeliveryAddress(address,1);
        }
    ...
    render(){
        ...
        if(this.props.shipping.hasOwnProperty('shipping_address')){
            shipping_address_id = this.props.shipping.shipping_address.address_id;
        }
        return(
            <div>
                        ...
                        <div className="col-xs-12 nopadding">
                            <div className="address_card" id="address_card">
                                <div id="myCarousel" className="carousel slide" data-ride="carousel">
                                        ...
                                        {this.props.shipping_addresses.map((address,key) =>
                                            {
                                                ...
                                                return(
                                                    <div className={item_class} key={key}>
                                                        <div className="address_penal" style={{margin:'5px',padding:'4%'}} >
                                                            <a href="javascript:void(0);" id={address.address_id} onClick={this.updateAddress.bind(this,address)}>
                                                                <ul>
                                                                ...
                                                                <div className="selected_address">
                                                                    ...
                                                                    <button type="button" className="btn deliver_address_btn">{this.props.language.button_delivery}</button>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                    ...
                                    {this.props.shipping_addresses.length == 1?(
