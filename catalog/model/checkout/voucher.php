...
class ModelCheckoutVoucher extends Model {
	...
	public function confirm($order_id) {
		...
		$order_info = OrderInfo::getOrderInfo($this->db, $order_id, '', $selector)['order'];
		...
		if ($order_info) {
			...
			foreach ($voucher_query->rows as $voucher) {
				...
				$mail->addAddress($voucher['to_email'], 'Customer');
