...
if (isset($_POST['submit_callback'])) {
    ...
    if (!empty($_POST['phone_number_callback'])) {
        ...
        //curl url       
        $curl_url = $crm_site_url."/api/callbackToMeBusinessLandingCo";
        ...
        <div class="slider_bg_color">
            <div class="container slider_contant">
                <div class="slider_contant_text">
                    ...
                    <span>                    
                             Yes, you are on right place. We are online wholesalers who provide all types of Indian fashion wholesale womens clothing like wholesale dresses, wholesale sarees etc. We also provide wholesale footwear, bags, mens wholesale clothing, kids wholesale clothing, bed-sheets etc. at a lowest factory price with a <span class="green"><b>guarantee of 25-30 % saving on your current buying</b>.</span>
                            </span>
                            <!-- <div class="col-sm-12 slider_input_box">
                                <div class="slider_input_section">     
                                    <form method="post" action="" name="callback_form" > 
                                        
                                        <input class="col-xs-4 form-control call_back_country_code" type="text" name="country_code" value="+1" style="width: 48px; height: 37px; display: none;" />

                                        <input type="text" name="phone_number_callback" id="phone_number_callback"  class="form-control slider_input" placeholder="Phone Number Or Email" required="required" />

                                        <input type="hidden" name="browser" class="browser" value=""/>

                                        <input type="hidden" name="mobile" class="callme_mobile" value=""/>

                                        <input type="hidden" name="email" class="callme_email" value=""/>

                                        <button type="submit" class="button slider_input_btn" name="submit_callback" onclick="return chkval();">Sign Up</button>      
                                    </form>
                                </div>                                
                            </div> -->
                             <div class="col-sm-12 slider_input_box slider_input_box_co">
                                <div class="mobile_btn">
                                    <a href="https://play.google.com/store/apps/details?id=in.wholesalebox&referrer=utm_source%3DLanding%26utm_medium%3Dtwitter_ad" target="_blank">
                                        <img src="<?php echo CDN_URL ?>landing-page/images/google-play-android-app.svg" alt="Android app on google play" width="180px">
                                    </a>
                                    <a href="https://itunes.apple.com/app/apple-store/id1254820324?mt=8" target="_blank">
                                        <img src="<?php echo CDN_URL ?>landing-page/images/ios_download.svg" alt="ios app on app store" width="180px">
                                    </a>
                                    <a href="https://www.wholesalebox.co/?tracking=577e51791bc08" target="_blank">
                                        <img src="<?php echo CDN_URL ?>landing-page/images/wsb_website.svg" alt="wholesatebox website" width="180px">
                                    </a>
                                </div>
    ...
    <div class="row">
        <Section class="col-lg-12 content_space">
            ...
            <div class="text-center padding_text_contant"><p>WholesaleBox is leading Online wholesale Supplier with the aim to provide goods <br> directly from manufacturers to Retailers at lowest factory price.</p></div>
             ...
             <div class="content_center content_center_co"><img src="<?php echo CDN_URL ?>landing-page/images/WSB_business_v2_co.jpg" alt="WholesaleBox work" class="img-responsive"></div>
            ...
            <div class="text-center padding_text_contant">
                <div class="about_text">
                    <ul>
                        ...
                        <li>Use the technology a boon for retailers to buy wholesale boutique clothing products on low wholesale price for their outlets.</li>
                        <li>You save time to travel in different cities / manufacturing hubs as we are wholesale clothing distributors at lowest factory prices.</li>
            ...
            <Section class="col-lg-12 content_space">
                ...
                <div class="text-center padding_text_contant">
                    <div class="col-sm-12 login_from">
                        ...
                        <form class="business_login_form" name="business_login_form" id="business_login_form" method="post" onsubmit="return validateAccount1('subscribe')">

                            <div class="col-sm-6 login_input">

                                <div class="col-xs-4 country_code padding_left_none">
                                    <input class="form-control" type="text" name="country_code" value="+1" />
                                </div>

                                <div class="col-xs-12 nopadding">
                                    <input type="text" id="contact" class="form-control phone_number_subscribe" placeholder="Phone Number" name="phone_number" required pattern="[1-9]{1}[0-9]{5,11}" x-moz-errormessage="Please enter the valid mobile number (e.g. 8696491521)" oninvalid="setCustomValidity(this.willValidate?'':'Please enter the valid mobile number (e.g. 8696491521)')" title="Please enter the valid mobile number (e.g. 8696491521)"/>
                                </div>
                                <div class="clearfix"></div>
                            </div>
            ...
            <div class="modal-body popup_scroll padding_top_bottem">
                <div class="mobile_details_panel popup_title">
                    ...
                    <div class="lp-element lp-pom-form popup_content">
                        <form name="business_account_form" id="business_account_form" action="" method="post" onsubmit="return validateAccount1('signup')">
                            <div class="form-group col-sm-6">

                                <div class="col-xs-4 padding_left_none">
                                    <input type="text" class="form-control" id="country_code" name="country_code" value="+1">
                                </div>

                                <div class="col-xs-12 nopadding">
                                    <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Phone Number" required pattern="[1-9]{1}[0-9]{5,11}" x-moz-errormessage="Please enter the valid mobile number (e.g. 8696491521)" oninvalid="setCustomValidity(this.willValidate?'':'Please enter the valid mobile number (e.g. 8696491521)')" title="Please enter the valid mobile number (e.g. 8696491521)">
                                </div>
                                <div class="clearfix"></div>
                            </div>
...
<footer>
    ...
    <!-- Trigger the modal with a button -->
        <button type="button" class="hide btn btn-info btn-lg myModalErrorMessage" data-toggle="modal" data-target="#myModalErrorMessage">Message button</button>

        <!-- Modal -->
        <div class="modal fade" id="myModalErrorMessage" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body message_status" data-status = "" data-url="">
                        <p class="model_error_msg"></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
...
function chkval() {
    ...
    var text = $("#phone_number_callback").val();
    //var country_code = $(".call_back_country_code").val();

    if (text == '') {        
        $(".myModalErrorMessage").click();
        $(".model_error_msg").text('Phone number or email is required.');
        return false;        
    }        

    if (isNaN(text)) {

        $(".call_back_country_code").hide();

        var mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;  
        
        if(!text.match(mailformat))  {            
            $(".myModalErrorMessage").click();
            $(".model_error_msg").text('Please Enter valid email address.');
            return false;
        }

        $(".callme_email").val(text);
    } else {        
        $(".call_back_country_code").show();
        var phoneno = /^[0-9]{6,12}$/;
        if (!text.match(phoneno))  
        {  
            $(".myModalErrorMessage").click();
            $(".model_error_msg").text('Please enter valid phone number.');
            return false; 
        }  
        $(".callme_mobile").val(text);
    }
}

function validateAccount1(flag) {
    ...
    if (flag == "subscribe_email") {
      ...
      else if(phone_number.length < 6 || phone_number.length > 12) {
          alert("Please input valid phone number");
          return false;
    }     
}

$("#phone_number_callback").keypress(function(e){  
