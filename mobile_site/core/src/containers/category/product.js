...
function createMarkup(html) {
 ...
 return (<div className="pd_list_card_view">
            ...
            { this.props.product.exp_dispatch_days > 0 ?
             ...
             <div className="pd_list_title">
             <Link to={Api.folder_path+this.props.product.href}>{this.props.product.name}</Link>
             </div>
             
             <div className="pd_list_rating_pickup">
               
               <div className="pd_list_rating" style={{marginRight:'5px'}}><span className="clip-tag">From {this.props.product.pickup_city}</span></div>
               
               <div className="pd_list_rating"><span className={rating_class}>{rating}</span></div>
             </div>
            ...
            {this.props.product.stock_status === 'out of stock' ?
              <button className="add_to_cart_full_btn out_of_stock_btn"><i className="fa fa-shopping-bag" aria-hidden="true"></i> &nbsp; Out Of Stock</button>
             :
