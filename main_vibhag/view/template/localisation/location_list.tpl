              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td style="width:40%" class="text-left"><?php if ($sort == 'address_1') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center">
                        <?php if (in_array($locations['location_id'], $selected)) { ?>
                  ...
                  <td style="width:40%" class="text-left"><?php echo $locations['address']; ?></td>
                  <td class="text-left"><?php echo $locations['sort_order']; ?></td>
                  <td class="text-left"><?php echo $locations['status']; ?></td>
