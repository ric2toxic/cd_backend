    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-currency" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-value"><span data-toggle="tooltip" title="Conversion rate which would be used on Razorpay to convert USD to INR">Conversion Rate</span></label>
            <div class="col-sm-10">
              <input type="text" name="conversion_rate" value="<?php echo $conversion_rate; ?>" placeholder="<?php echo $entry_value; ?>" id="input-value" class="form-control" />
            </div>
          </div>
          
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-country-code"><span data-toggle="tooltip"  title="<?php echo htmlspecialchars($help_country_code); ?>"><?php echo $entry_country_code; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="country_code" value="<?php echo $country_code; ?>" placeholder="<?php echo $entry_country_code; ?>" id="input-country-code" class="form-control" />
