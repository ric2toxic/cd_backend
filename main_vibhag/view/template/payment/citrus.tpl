       ...
       <div class="col-sm-10"> 
		 ...
		 <div class="form-group">
            <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_module; ?></label>
              <div class="col-sm-10">
                  <select name="citrus_module"id="input-status" class="form-control">
		   ...
		   <div class="form-group">
               <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_vanityurl; ?></label>
                  <div class="col-sm-10">
                      <input type="text" name="citrus_vanityurl" value="<?php echo $citrus_vanityurl; ?>" id="input-sort-order"class="form-control" />
		  ...
		  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_access_key; ?></label>
                   <div class="col-sm-10">
                      <input type="text" name="citrus_access_key" value="<?php echo $citrus_access_key; ?>"  id="input-sort-order"class="form-control" />
		  ...
		  <div class="form-group">
               <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_secret_key; ?></label>
                 <div class="col-sm-10">
                    <input type="text" name="citrus_secret_key" value="<?php echo $citrus_secret_key; ?>"  id="input-sort-order"class="form-control" />
          ...
          <div class="form-group">
             <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_order_status; ?></label>
               <div class="col-sm-10">
                 <select name="citrus_order_status_id" id="input-status" class="form-control">
          ...
          <div class="form-group">
             <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_order_fail_status; ?></label>
               <div class="col-sm-10">
                 <select name="citrus_order_fail_status_id" id="input-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $citrus_order_fail_status_id) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
          ...
          <div class="form-group">
              <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_status; ?></label>
                 <div class="col-sm-10">
                   <select name="citrus_status" id="input-status" class="form-control">
          ...
          <div class="form-group">
               <label class="col-sm-2 control-label" for="input-total"><?php echo $entry_sort_order; ?></label>
               	 <div class="col-sm-10">
                      <input type="text" name="citrus_sort_order" value="<?php echo $citrus_sort_order; ?>"  id="input-sort-order"class="form-control"size="1" />
                 </div>
          </div>
      </form>
      </div>
