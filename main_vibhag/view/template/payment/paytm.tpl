	  ...
	  <div class="form-group required">
		...
		<?php if ($paytm_environment == "P") { ?>
		  ...
		  <div class="form-group">
            ...
            <div class="form-group required">
                <label class="control-label col-sm-3" for="paytm_store"><span data-toggle="tooltip" title="<?php echo $entry_store_help; ?>"><?php echo $entry_store; ?></span></label>
                <div class="col-sm-9">
                    <select name="paytm_store" class="form-control">
                        <option value="" selected="selected">select</option>
                    <?php $selctd = "";
                        foreach($stores as $store) {
                            if($paytm_store == $store['store_id']) {
