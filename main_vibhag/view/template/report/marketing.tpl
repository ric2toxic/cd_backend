  ...
  <div class="container-fluid">
    <div class="panel panel-default">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
             <!--  <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label" for="input-report"><?php echo $entry_report; ?></label>
                <select name="filter_report_name" id="input-report" class="form-control">
     ...
     <!--    <div class="table-responsive">
        ...
        <div>
          <?php if($html) { ?>
          <div class="col-sm-12 text-left"><?php echo $html; ?></div> 
          <?php } else { ?>
          <div class="col-sm-12 text-left"><strong><?php echo $text_no_results; ?></strong></div> 
          <?php } ?>
        </div>
        <!-- <div class="row">
  ...
  <script type="text/javascript"><!--
    $(document).ready(function(){
      $('#button-filter').on('click', function() {
        ...
        var filter_report_name = $('select[name=\'filter_report_name\']').val();
        
        if (filter_report_name != "") {
          url += '&filter_report_name=' + encodeURIComponent(filter_report_name);
        } 
