  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <?php if ($filter_order_status_id == -2 || $filter_order_status_id == 0) { ?>
            <span class="pull-right">(Pending Orders)</span>
        <?php }?>
      </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <select name="filter_order_status_id" id="input-status" class="form-control">
                  ...
                  <option value="-2">All Except Cancelled</option>
                  
                  <option value="0" <?php if ($filter_order_status_id == 0) { ?>
                  selected="selected" <?php } ?>><?php echo $text_all_status; ?></option>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right">No. Suborders</td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right">
                    ...
                    if ($order['pending_orders'] > 0) { 
                        echo(' ('. $order['pending_orders'] . ')'); 
                    }?>
                </td>                <td class="text-right">
                    <?php echo($order['suborders']); 
                    if ($order['pending_suborders'] > 0) { 
                        echo(' ('. $order['pending_suborders'] . ')'); 
                    }?>
                </td>
                <td class="text-right">
                    <?php echo($order['total']);
                    if ($order['pending_suborders'] > 0) {
                        echo(' ('. $order['pending_total'] . ')'); 
                    }?>
                </td>
              </tr>
              <?php } ?>
