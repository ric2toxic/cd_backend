            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'home_side_banner') { ?>
                        <option value="home_side_banner" selected="selected">Home Side Banner</option>
                    <?php } else { ?>
                        <option value="home_side_banner">Home Side Banner</option>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'mobile_slide_b') { ?>
                    <option value="mobile_slide_b" selected="selected">mobile slide banner</option>
                    <?php } else { ?>
                    <option value="mobile_slide_b">mobile slide banner</option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="home_side_banner">Home Side Banner</option>';
    html += '    <option value="home_side_banner">Footer Top</option>';
    html += '    <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
    html += '    <option value="column_left"><?php echo $text_column_left; ?></option>';
    html += '    <option value="column_right"><?php echo $text_column_right; ?></option>';
    html += '    <option value="mobile_slide_b">Mobile slide Banner</option>';
    html += '  </select></td>';
