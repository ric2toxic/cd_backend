...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1><?php echo $heading_salesreports; ?></h1>
      <ul class="breadcrumb">
          ...
          <div class="row">
            <div class="col-sm-4">
             <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_invoice_date_from" value="<?php echo $filter_invoice_date_from; ?>" placeholder="<?php echo $entry_invoice_date_from; ?>" data-date-format="YYYY-MM-DD" id="input-invoice-date" class="form-control" />
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_invoice_date_to" value="<?php echo $filter_invoice_date_to; ?>" placeholder="<?php echo $entry_invoice_date_to; ?>" data-date-format="YYYY-MM-DD" id="input-invoice-date" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span>
                </div>
...
$('#button-filter').on('click', function() {
  base_url = 'index.php?route=accounts/salesreports&token=<?php echo $token. ( $is_tally ? "&tally=1" : ''  ); ?>';
  var url = base_url;
  ...
  var filter_invoice_date_from = $('input[name=\'filter_invoice_date_from\']').val();
