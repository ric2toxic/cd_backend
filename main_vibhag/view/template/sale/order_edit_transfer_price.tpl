<div class="row products_panel hidden tabs edit_transfer_price">
  <div class="col-lg-12">
      <form action="<?php echo $update_transfer_price; ?>" id="product_form" method="post">
        ...
        <input type="hidden" name="edit_transfer_price" value="1" />
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <td>Sets</td>
              <td>Total Pieces</td>
              <td>Per Piece Transfer Price</td>
                  ...
                  <tbody style="border:3px solid #000">
                    <?php  foreach( $combo_product as $product ) { 
                        ...
                        <tr>
                          ...
                          <td width="150px">
                            <span><?php echo $product['transfer_price_per_piece']; ?></span>
                            <?php if( empty($product['seller_invoice_id']) || $product['seller_invoice_id'] == 0 || $is_admin == 1 ) { ?>
                            <a title="Edit product transfer price" href="javascript:void(0);" data-product-id="<?php echo $product['order_product_id']?>" class="update-transfer-price">
                              <i class="fa fa-pencil"></i>
                            </a>
                            <div style="display: none" id="edit_transfer_price_<?php echo $product['order_product_id']?>">
                              <input type="hidden" name="transfer_price[<?php echo $product['order_product_id']?>][old]" class="form-control numbers" style="width:90px" value="<?php echo $product['transfer_price_per_piece']; ?>">
                              <input type="text" name="transfer_price[<?php echo $product['order_product_id']?>][new]" class="form-control numbers" style="width:90px" value="<?php echo $product['transfer_price_per_piece']; ?>">
                            </div>
                            <?php } else { ?>
                              <span style="font-size: 11px; color: #f56b6b">Invoiced already! cannot be edited</span>
                            <?php } ?>
                          </td>
                          <td width="150px">
                    ...
                    <?php foreach( $order_combo_product as $product ) { 
                        ...
                        <tr>
                          ...
                          <td width="150px">
                            ...
                            <?php } else { ?>
                              <br><span style="font-size: 11px; color: #f56b6b">Invoiced already! cannot be edited</span>
                            <?php } ?>
                          </td>
                          <td width="150px">
                            <span><?php echo $product['comment']; ?></span>
...
$(document).on('click','.update-transfer-price',function(){

  var product_id = $(this).data('product-id');
  $('#edit_transfer_price_'+product_id).toggle();
