...
<div class="container">
  ...
  <div style="page-break-after: always;">
    ...
    <td style="width:33%;"> <?php if ($order['gati_ou']) {
        echo $order['gati_ou']; 
    } ?> </td>
    <td align="center" style="width:33%;"><?php echo $text_retail .$text_invoice . $order['invoice_no']; ?></td>
    <td align="right" style="width:33%;"> <?php if ($order['tracking_no']) { 
    ...
    <table class="table table-bordered" style="margin-bottom: 5px">
      <thead>
        <tr>
        <td class="invoice" style="width: 50%;"><?php echo $text_ship_to; ?></td>
        <td class="invoice" style="width: 50%;"><?php echo $text_order_detail; ?></td>
        </tr>
      </thead>
      <tbody>
        <tr>
        ...
        <td class="invoice">
            ...
            <h5><?php echo $text_telephone; ?><strong><?php echo $order['telephone']; ?></strong>
            <?php if ($order['tracking_no'] and $order['barcode']) { ?>
                <img title="<?php echo $order['tracking_no']; ?>" alt="<?php echo $order['tracking_no']; ?>" src="<?php echo $order['barcode']; ?>" />
            <?php } ?></h5>
        </td>
        ...
        <td class="invoice"><address>
            ...
            <!-- <b><?php echo $text_whatsapp; ?></b> <?php //echo "+918696491521"; ?><br /> -->
    ...
    <table class="table table-bordered"  style="margin-bottom: 5px">
      <thead>
        <tr>
          ...
          <td class="invoice-right-text"><b><?php echo $column_quantity; ?></b></td>
      ...
      <tbody>
        ...
        <tr>
            <td class="invoice-right-text" colspan="4"><b><?php echo $total['title']; ?></b></td>
            <?php if ($total['code'] == 'total') {?>
                <td class="invoice-right-text" style="border:solid; font-size:14px;"><strong><?php echo $total['text']; ?></strong></td>
            <?php } else { ?>
