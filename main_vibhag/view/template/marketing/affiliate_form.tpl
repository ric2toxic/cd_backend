        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-affiliate" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-discount-amount"><?php echo $entry_discount_amount; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="discount_amount" value="<?php echo $discount_amount; ?>" placeholder="<?php echo $entry_discount_amount; ?>" id="input-discount-amount" class="form-control" />
                  <?php if ($error_discount_amount) { ?>
                  <div class="text-danger"><?php echo $error_discount_amount; ?></div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="text-danger"><?php echo $error_uses_customer; ?></div>
                  <?php } ?>
                </div>
              </div>
