  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">   
          <h3 class="panel-title" style="margin-top: 10px"><i class="fa fa-list"></i><span style="color: #1e91cf"><?php echo (!empty($label_text) ? $label_text: $text_list); ?></span></h3>
        <?php if($category_id != '' && $category_id != '0'){ ?>
            <a class='pull-right btn btn-default' href="<?php echo $parent_link; ?>"><i class="fa fa-reply"></i></a>
        <?php } ?>
      </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $column_total_sub_category; ?></td> 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $category['total_sub_category']; ?></td> 
                  <td class="text-right"><?php echo $category['sort_order']; ?></td>
                  <td class="text-right">
                      <?php if($category['sub_cat'] != ''){ ?>
                      <a href="<?php echo $category['sub_cat']; ?>" data-toggle="tooltip" title="Child category" class="btn btn-primary"><i class="fa fa-list"></i></a>
                      <?php } ?>
