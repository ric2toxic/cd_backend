                  ...
                  <div class="pull-left col-md-5">
                    ...
                    <div>
                      <form action="" method="post" id="form-return" class="form-horizontal" enctype="multipart/form-data">
                        <input type="file" name="shadowfax_upload" class="upload-form-input">
          ...
          <table class="table table-bordered table-hover">
            ...
            <?php if(isset($filter_pincodes) && !empty($filter_pincodes)) { ?>
              ...
              <tr>
                ...
                <td class="text-left">
                  <span><?php echo $filter_pincode["hub"] ?></span>
                </td>
                <td class="text-left">
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function() {
    url = 'index.php?route=logistic/shadowfax&token=<?php echo $token; ?>';
