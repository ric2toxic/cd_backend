                  ...
                  <div class="pull-left col-md-5">
                    ...
                    <div>
                      <form action="" method="post" id="form-return" class="form-horizontal" enctype="multipart/form-data">
                        <input type="file" name="bluedart_upload" class="upload-form-input">
           ...
           <thead>
            <tr>
              ...
              <td class="text-left">
               ...
               <td class="text-left">
                <span style="color: #000;">Cscrcd</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Bdel Loc</span>
              </td>
              <td class="text-left">
            ...
            <?php if(isset($filter_pincodes) && !empty($filter_pincodes)) { ?>
              ...
              <tr>
                <td class="text-left">
                  <input class="selectedPincodes" type="checkbox" name="selected[]" value="<?php echo $filter_pincode['pincode'].'|'.$filter_pincode['mode']; ?>" />
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["mode"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["pincode"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["cscrcd"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["bdel_loc"] ?></span>
                </td>
                <td class="text-left">
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function() {
    url = 'index.php?route=logistic/bluedart&token=<?php echo $token; ?>';
  ...
  $("#button-update-status").on("click",function(){
    ...
    if(selected_pincodes.length > 0 ) {
      ...
      url = 'index.php?route=logistic/bluedart/update_status&token=<?php echo $token; ?>';
