                  ...
                  <div class="pull-left col-md-5">
                    ...
                    <div>
                      <form action="" method="post" id="form-return" class="form-horizontal" enctype="multipart/form-data">
                        <input type="file" name="gati_upload" class="upload-form-input">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td class="text-left">
                  <span style="color: #000;">Serviceability</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Edc</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Gdw</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">State</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Ou Category</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Ou</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Ou Name</span>
              </td>
              <td class="text-left">
                <span style="color: #000;">Pincode</span>
              </td>
            ...
            <?php if(isset($filter_pincodes) && !empty($filter_pincodes)) { ?>
              ...
              <tr>
                ...
                <td class="text-right">
                  <span><?php echo $filter_pincode["serviceability"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["edc"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["gdw"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["state"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["ou_category"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["ou"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["ou_name"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["pincode"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["distance"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["cod"] ?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["prepaid"] ?></span>
                </td>
                <td class="text-left">
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function() {
    url = 'index.php?route=logistic/gati&token=<?php echo $token; ?>';
  ...
  $("#button-update-status").on("click",function(){
    ...
    if(selected_pincodes.length > 0 ) {
      ...
      url = 'index.php?route=logistic/gati/update_status&token=<?php echo $token; ?>';
