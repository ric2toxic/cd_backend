                  ...
                  <div class="pull-left col-md-5">
                    ...
                    <div>
                      <form action="" method="post" id="form-return" class="form-horizontal" enctype="multipart/form-data">
                        <input type="file" name="fedex_upload" class="upload-form-input">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td class="text-center">
                <span style="color: #000;">ODA-OPA / Regular Classification (Dom +Intl)</span>
              </td>
              <td class="text-center">
                <span style="color: #000;">International Services</span>
              </td>
              <td class="text-center">
                <span style="color: #000;">Domestic Service</span>
              </td>
              <td class="text-center">
                <span style="color: #000;">COD Serviceable (Domestic Only)</span>
              </td>
              <td class="text-center">
            ...
            <?php if(isset($filter_pincodes) && !empty($filter_pincodes)) { ?>
              ...
              <tr>
               ...
               <td class="text-right">
                  <span><?php echo $filter_pincode["oda_opa_or_reg"] ?></span>
                </td>  
                <td class="text-right">
                  <span><?php echo $filter_pincode["intl_services"] ?></span>
                </td> 
                <td class="text-right">
                  <span><?php echo $filter_pincode["dom_service"] ?></span>
                </td> 
                <td class="text-right">
                  <span><?php echo ($filter_pincode["cod_serviceable"])?'COD':'NO COD' ?></span>
                </td>
                <td class="text-left">
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function() {
    url = 'index.php?route=logistic/fedex&token=<?php echo $token; ?>';
   ...
   $("#button-update-status").on("click",function(){
    ...
    if(selected_pincodes.length > 0 ) {
      ...
      url = 'index.php?route=logistic/fedex/update_status&token=<?php echo $token; ?>';
