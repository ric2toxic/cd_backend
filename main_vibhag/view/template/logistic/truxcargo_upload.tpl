                  ...
                  <div class="pull-left col-md-5">
                    ...
                    <div>
                      <form action="" method="post" id="form-return" class="form-horizontal" enctype="multipart/form-data">
                        <input type="file" name="truxcargo_upload" class="upload-form-input">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <td class="text-left">
                <span style="color: #000;"><?php echo $text_product_type?></span>
              </td>
              <td class="text-left">
                <span style="color: #000;"><?php echo $text_center?></span>
              </td>
              <td class="text-left">
                <span style="color: #000;"><?php echo $text_facility_type?></span>
              </td>
              <td class="text-left">
                <span style="color: #000;"><?php echo $text_weight_limit?></span>
              </td>
              <td class="text-left">
                <span style="color: #000;"><?php echo $text_remark?></span>
              </td>
              <td class="text-left">
            ...
            <?php if(isset($filter_pincodes) && !empty($filter_pincodes)) { ?>
              ...
              <tr>
                ...
                <td class="text-left">
                  <span><?php echo $filter_pincode["product_type"]?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["center"]?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["facility_type"]?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["weight_limit"]?></span>
                </td>
                <td class="text-left">
                  <span><?php echo $filter_pincode["remark"]?></span>
                </td>
                <td class="text-left">
...
<script type="text/javascript">
  ...
  $('#button-filter').on('click', function() {
    url = 'index.php?route=logistic/truxcargo&token=<?php echo $token; ?>';
   ...
   $("#button-update-status").on("click",function(){
    ...
    if(selected_pincodes.length > 0 ) {
      ...
      url = 'index.php?route=logistic/truxcargo/update_status&token=<?php echo $token; ?>';
