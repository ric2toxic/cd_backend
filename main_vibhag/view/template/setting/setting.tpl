        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-cart-limit"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_cart_limit; ?>"><?php echo $entry_cart_limit; ?></span></label>
                    <div class="col-sm-10">
              ...
              <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-config-limit"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_limit; ?>"><?php echo $entry_limit; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_limit" value="<?php echo $config_limit; ?>" placeholder="<?php echo $entry_limit; ?>" id="input-config-limit" class="form-control" />
                    </div>
              </div>
				<div class="form-group">
                    <label class="col-sm-2 control-label" for="input-config-limit-dropshipper"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_limit; ?>"><?php echo $entry_limit_dropshipper; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_dropshipper_cart_limit" value="<?php echo $config_dropshipper_cart_limit; ?>" placeholder="<?php echo $entry_limit_dropshipper; ?>" id="input-config-dropshipper-limit" class="form-control" />
                    </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_maintenance; ?>"><?php echo $entry_app_maintenance; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_app_maintenance) { ?>
                    <input type="radio" name="config_app_maintenance" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_app_maintenance" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_app_maintenance) { ?>
                    <input type="radio" name="config_app_maintenance" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_app_maintenance" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
