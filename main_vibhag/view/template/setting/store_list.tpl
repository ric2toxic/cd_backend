            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right">Add Products</td>
                </tr>
              </thead>
              <tbody>
                <?php if ($stores) { ?>
                ...
                <tr>
                  <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo $store['store_id']; ?>" /></td>
                  ...
                  <?php if ($store['store_id'] != 0 AND $store['store_id'] != 2) { ?>
                  <td class="text-right"><a href="<?php echo $store['add_products']; ?>" data-toggle="tooltip" title="Add Products to this store" class="btn btn-primary"><i class="fa fa-plus"></i></a></td>
                  <?php } ?>
                </tr>
                <?php } ?>
                <?php } else { ?>
