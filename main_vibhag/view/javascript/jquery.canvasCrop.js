...
(function(factory){
    ...
    function BoxLayout(obj){  //Box model
        
        this.x = obj.offset().left; //Viewport left margin
        this.y = obj.offset().top; //Viewport top margin
        this.width = obj.width(); 
        this.height = obj.height();
        this.left = obj.position().left; //Relative parent left margin
        this.top = obj.position().top; //Relative parent margin
    }
    ...
    $.CanvasCrop = function(options){
        ...
        var opts = $.extend({},{
            ...
            canvasInit = function(){
                ...
                img.onerror = function(){
                    alert("Download or Upload image error");
                }
            },
            limitOver = function(){
                var w = img.width,
            ...
            innerRotate = function(){
                ...
                //The size of the canvas tag after rotation
            ...
            getScale = function(){  //Get zoomed height and height
            ...
            setPosition = function(imgDis){
                ...
                visbleCanvasBox = {  //Save the canvas coordinates
                    left: imgDis.x,
                    top: imgDis.y
                };
                clipArgument = {  //Save the generated image coordinates after cutting
            ...
            canvasTransform = function(options){
                ...
                var pos = getPosition(oldWidth,oldHeight); //Calculate the changed coordinates
                setPosition(pos); //Set the changed coordinates
            };
        ...
        var returnObj = {
            ...
            getDataURL: function(type,imgUpload){
                var type = type||"png",
                ...
                if(imgUpload !='0'){
                    ...
                    var newWidth=clipArgument.dx-100;
                    var newHeight=clipArgument.dy-24;
                    hiddenContext.drawImage(visbleCanvas, newWidth,newHeight,visbleCanvas.width,visbleCanvas.height);  
                }
