...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('module/slideshow', $data);
		...
		if (isset($this->request->post['banner_id'])) {
            ...
            $data['international_desktop_banner_id'] = $module_info['international_desktop_banner_id'];
			$data['international_mobile_banner_id'] = isset($module_info['international_mobile_banner_id']) ? $module_info['international_mobile_banner_id'] : '';
			$data['home_mobile_banner_id'] = isset($module_info['home_mobile_banner_id']) ? $module_info['home_mobile_banner_id'] : '';
		} else {
			$data['banner_id'] = '';
		}
