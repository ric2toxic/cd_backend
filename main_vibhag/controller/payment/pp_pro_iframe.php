...
class ControllerPaymentPPProIframe extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('payment/pp_pro_iframe', $data);
	...
	public function refund() {
		...
		$this->document->setTitle($data['text_refund']);
	...
	public function viewTransaction() {
		...
		$this->document->setTitle($data['text_transaction']);
