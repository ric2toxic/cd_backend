...
class ControllerPaymentPPPayflowIframe extends Controller {
	...
	public function index() {
		...
		$this->load->autoLoadLanguage('payment/pp_payflow_iframe',$data);
		...
		if ($paypal_order) {
			...
			foreach ($transactions as $transaction) {
				...
				switch ($transaction['transaction_type']) {
					case 'V':
						$transaction_type = $data['text_void'];
						break;
					case 'S':
						$transaction_type = $data['text_sale'];

						$actions[] = array(
							'title' => $data['text_refund'],
						...
						break;
					case 'D':
						$transaction_type = $data['text_capture'];
						...
						break;
					case 'A':
						$transaction_type = $data['text_authorise'];
						break;

					case 'C':
						$transaction_type = $data['text_refund'];
						break;
