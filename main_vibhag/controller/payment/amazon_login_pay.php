...
class ControllerPaymentAmazonLoginPay extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('payment/amazon_login_pay', $data);
		...
		$data['declined_codes'] = array($data['text_amazon_invalid'], $data['text_amazon_rejected'], $data['text_amazon_timeout']);
