...
class ControllerPaymentSecureTradingWs extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('payment/securetrading_ws', $data);
		...
		$data['settlement_statuses'] = array(
			'0' => $data['text_pending_settlement'],
			'1' => $data['text_pending_settlement_manually_overriden'],
			'2' => $data['text_pending_suspended'],
			'100' => $data['text_pending_settled'],
		);
	...
	public function showTransactions() {
		...
		$status_mapping = array(
			'0' => $data['text_ok'],
			'70000' => $data['text_denied'],
		);

		$settle_status_mapping = array(
			'0' => $data['text_pending_settlement'],
			'1' => $data['text_manual_settlement'],
			'2' => $data['text_suspended'],
			'3' => $data['text_cancelled'],
			'10' => $data['text_settling'],
			'100' => $data['text_settled'],
		);
