...
class ControllerPaymentAmazonCheckout extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('payment/amazon_checkout', $data);
		...
		$data['button_colours'] = array(
			'orange' => $data['text_orange'],
			'tan'    => $data['text_tan']
		);

		$data['button_backgrounds'] = array(
			'white' => $data['text_white'],
			'light' => $data['text_light'],
			'dark'  => $data['text_dark'],
		);

		$data['button_sizes'] = array(
			'medium'  => $data['text_medium'],
			'large'   => $data['text_large'],
			'x-large' => $data['text_x_large'],
		);
