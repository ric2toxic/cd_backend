...
class ControllerLocalisationStockStatus extends Controller {
	...
	protected function getList() {
		...
		$data = array();
		$this->load->autoLoadLanguage('localisation/stock_status',$data);
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['stock_status_id']) ? $data['text_add'] : $data['text_edit'];
