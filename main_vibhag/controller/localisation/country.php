...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getList() {
	    ...
	    $this->load->autoLoadLanguage('localisation/country', $data);
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['country_id']) ? $data['text_add'] : $data['text_edit'];
