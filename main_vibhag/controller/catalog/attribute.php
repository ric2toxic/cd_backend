...
class ControllerCatalogAttribute extends Controller {
	...
	protected function getList() {
        ...
        $this->load->autoLoadLanguage('catalog/attribute', $data);
		...
		$data['results'] = sprintf($data['text_pagination'], ($attribute_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($attribute_total - $this->config->get('config_limit_admin'))) ? $attribute_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $attribute_total, ceil($attribute_total / $this->config->get('config_limit_admin')));
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['attribute_id']) ? $data['text_add'] : $data['text_edit'];
