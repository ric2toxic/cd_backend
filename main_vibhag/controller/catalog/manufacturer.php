...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() {
        ...
        $this->load->autoLoadLanguage('catalog/manufacturer', $data);
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['manufacturer_id']) ? $data['text_add'] : $data['text_edit'];
