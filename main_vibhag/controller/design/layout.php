...
class ControllerDesignLayout extends Controller {
	...
	protected function getList() {
        ...
        $this->load->autoLoadLanguage('design/layout', $data);
		...
		$data['results'] = sprintf($data['text_pagination'], ($layout_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($layout_total - $this->config->get('config_limit_admin'))) ? $layout_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $layout_total, ceil($layout_total / $this->config->get('config_limit_admin')));
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['layout_id']) ? $data['text_add'] : $data['text_edit'];
