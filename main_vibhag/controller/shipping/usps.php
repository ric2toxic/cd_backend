...
class ControllerShippingUsps extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('shipping/usps', $data);
		...
		$data['sizes'][] = array(
			'text'  => $data['text_regular'],
			'value' => 'REGULAR'
		);

		$data['sizes'][] = array(
			'text'  => $data['text_large'],
			'value' => 'LARGE'
		);
		...
		$data['containers'][] = array(
			'text'  => $data['text_rectangular'],
			'value' => 'RECTANGULAR'
		);

		$data['containers'][] = array(
			'text'  => $data['text_non_rectangular'],
			'value' => 'NONRECTANGULAR'
		);

		$data['containers'][] = array(
			'text'  => $data['text_variable'],
			'value' => 'VARIABLE'
		);
