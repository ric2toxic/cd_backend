...
class ControllerShippingUPS extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('shipping/ups', $data);
		...
		$data['pickups'][] = array(
			'value' => '07',
			'text'  => $data['text_on_call_air_pickup']
		);
		...
		$data['pickups'][] = array(
			'value' => '11',
			'text'  => $data['text_suggested_retail_rates']
		);
		...
		$data['packages'][] = array(
			'value' => '02',
			'text'  => $data['text_package']
		);

		$data['packages'][] = array(
			'value' => '01',
			'text'  => $data['text_ups_letter']
		);

		$data['packages'][] = array(
			'value' => '03',
			'text'  => $data['text_ups_tube']
		);

		$data['packages'][] = array(
			'value' => '04',
			'text'  => $data['text_ups_pak']
		);

		$data['packages'][] = array(
			'value' => '21',
			'text'  => $data['text_ups_express_box']
		);

		$data['packages'][] = array(
			'value' => '24',
			'text'  => $data['text_ups_25kg_box']
		);

		$data['packages'][] = array(
			'value' => '25',
			'text'  => $data['text_ups_10kg_box']
		);
		...
		$data['quote_types'][] = array(
			'value' => 'residential',
			'text'  => $data['text_residential']
		);

		$data['quote_types'][] = array(
			'value' => 'commercial',
			'text'  => $data['text_commercial']
		);
