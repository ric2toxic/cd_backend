...
class ControllerShippingFedex extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('shipping/fedex', $data);
		...
		$data['services'][] = array(
			'text'  => $data['text_europe_first_international_priority'],
			'value' => 'EUROPE_FIRST_INTERNATIONAL_PRIORITY'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_1_day_freight'],
			'value' => 'FEDEX_1_DAY_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_2_day'],
			'value' => 'FEDEX_2_DAY'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_2_day_am'],
			'value' => 'FEDEX_2_DAY_AM'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_2_day_freight'],
			'value' => 'FEDEX_2_DAY_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_3_day_freight'],
			'value' => 'FEDEX_3_DAY_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_express_saver'],
			'value' => 'FEDEX_EXPRESS_SAVER'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_first_freight'],
			'value' => 'FEDEX_FIRST_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_freight_economy'],
			'value' => 'FEDEX_FREIGHT_ECONOMY'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_freight_priority'],
			'value' => 'FEDEX_FREIGHT_PRIORITY'
		);

		$data['services'][] = array(
			'text'  => $data['text_fedex_ground'],
			'value' => 'FEDEX_GROUND'
		);

		$data['services'][] = array(
			'text'  => $data['text_first_overnight'],
			'value' => 'FIRST_OVERNIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_ground_home_delivery'],
			'value' => 'GROUND_HOME_DELIVERY'
		);

		$data['services'][] = array(
			'text'  => $data['text_international_economy'],
			'value' => 'INTERNATIONAL_ECONOMY'
		);

		$data['services'][] = array(
			'text'  => $data['text_international_economy_freight'],
			'value' => 'INTERNATIONAL_ECONOMY_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_international_first'],
			'value' => 'INTERNATIONAL_FIRST'
		);

		$data['services'][] = array(
			'text'  => $data['text_international_priority'],
			'value' => 'INTERNATIONAL_PRIORITY'
		);

		$data['services'][] = array(
			'text'  => $data['text_international_priority_freight'],
			'value' => 'INTERNATIONAL_PRIORITY_FREIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_priority_overnight'],
			'value' => 'PRIORITY_OVERNIGHT'
		);

		$data['services'][] = array(
			'text'  => $data['text_smart_post'],
			'value' => 'SMART_POST'
		);

		$data['services'][] = array(
			'text'  => $data['text_standard_overnight'],
