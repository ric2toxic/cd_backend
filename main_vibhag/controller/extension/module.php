...
class ControllerExtensionModule extends Controller {
	...
	public function getList() {
        ...
        $data = array();
        $this->load->autoLoadLanguage('extension/module',$data);
		...
		$data['text_layout'] = sprintf($data['text_layout'], $this->url->link('design/layout', 'token=' . $this->session->data['token'], 'SSL'));
