...
class ControllerExtensionModification extends Controller {
	...
	protected function getList() {
		...
		$data = array();
		$this->load->autoLoadLanguage('extension/modification',$data);
		...
		$data['results'] = sprintf($data['text_pagination'], ($modification_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($modification_total - $this->config->get('config_limit_admin'))) ? $modification_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $modification_total, ceil($modification_total / $this->config->get('config_limit_admin')));
