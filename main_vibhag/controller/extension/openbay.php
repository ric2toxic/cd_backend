...
class ControllerExtensionOpenbay extends Controller {
	...
	public function orderList() {
		...
		$data = array();
		$this->load->autoLoadLanguage('openbay/openbay_order', $data);
		//$this->load->autoLoadLanguage('openbay/openbay_order', $data);
		...
		foreach ($results as $result) {
			$channel = $data['text_' . $result['channel']];
