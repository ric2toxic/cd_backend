...
class ControllerMarketingCoupon extends Controller {
	...
	protected function getList() {
	    ...
	    $this->load->autoLoadLanguage('marketing/coupon', $data);
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['coupon_id']) ? $data['text_add'] : $data['text_edit'];
		...
		foreach ($customers as $customer_id) {
            $fields = array( 'customer_id' , 'firstname' , 'lastname'  );
			$customer_info = $this->model_sale_customer->getCustomerById($customer_id,$fields);
    ...
    public function autocompleteCustomer(){
        if(!empty($this->request->get)){
            ...
            $customer = $this->model_sale_customer->getCustomerList($data);
