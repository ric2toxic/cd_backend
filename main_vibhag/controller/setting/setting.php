...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
	    ...
	    $this->load->autoLoadLanguage('setting/setting', $data);
		...
		if (isset($this->request->post['config_store_code'])) {
			...
			$data['config_store_code'] = $this->config->get('config_store_code');
		}
        ...
        if (isset($this->request->post['config_limit'])) {
            $data['config_limit'] = $this->request->post['config_limit'];
        } else {
            $data['config_limit'] = $this->config->get('config_limit');
        }
        
        if (isset($this->request->post['config_cart_limit'])) {
            $data['config_cart_limit'] = $this->request->post['config_cart_limit'];
        } else {
            $data['config_cart_limit'] = $this->config->get('config_cart_limit');
        }
        if (isset($this->request->post['config_dropshipper_cart_limit'])) {
            $data['config_dropshipper_cart_limit'] = $this->request->post['config_dropshipper_cart_limit'];
        } else {
            $data['config_dropshipper_cart_limit'] = $this->config->get('config_dropshipper_cart_limit');
        }
		...
		if (isset($this->request->post['config_app_maintenance'])) {
			$data['config_app_maintenance'] = $this->request->post['config_app_maintenance'];
		} else {
			$data['config_app_maintenance'] = $this->config->get('config_app_maintenance');
		}
