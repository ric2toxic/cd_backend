...
class ControllerSaleVoucherTheme extends Controller {
	...
	protected function getList() {
	    ...
	    $this->load->autoLoadLanguage('sale/voucher_theme', $data);
	...
	protected function getForm() {
		...
		$data['text_form'] = !isset($this->request->get['voucher_theme_id']) ? $data['text_add'] : $data['text_edit'];
