...
class ModelMarketingMarketing extends Model {
	...
	public function getMarketings($data = array()) {
		...
		FROM `" . DB_PREFIX . "order` o WHERE (" . implode(" OR ", $implode) . ") AND o.marketing_id = m.marketing_id  AND o.store_id IN (".WSB_STORES_ID .") AND o.franchise_id = 0 ) AS orders FROM " . DB_PREFIX . "marketing m";
