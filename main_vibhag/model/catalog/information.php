...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
        ...
        // to translate information into local language
        $this->load->model('localisation/reverie','frontend');
        $this->frontend_model_localisation_reverie->translateInformation($data['information_description'][1], $information_id);
	...
	public function getInformationStores($information_id) {
		...
		$query = $this->db->query("SELECT DISTINCT store_id FROM " . DB_PREFIX . "information_to_store WHERE information_id = '" . (int)$information_id . "'");
	...
	public function getInformationLayouts($information_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "information_to_layout WHERE information_id = '" . (int)$information_id . "' AND store_id IN (".WSB_STORES_ID .")");
	...
	public function getTotalInformationsByLayoutId($layout_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "information_to_layout WHERE layout_id = '" . (int)$layout_id . "' AND store_id IN (".WSB_STORES_ID .")");
