...
$_['entry_cart_limit']                 = 'Minimum Cart Value Required';
...
$_['entry_seller_store']               = 'Seller Name Required';
$_['entry_select_none']                = 'Select a seller (optional)';
...
$_['entry_seller_commission']          = 'Enter the seller commission';
$_['entry_config_store_body_wrapper_css'] = 'Enter the css class to wrap body - Developer use only';
$_['entry_config_store_custom_css']    = 'Enter the custom css - Developer use only';
$_['entry_config_store_custom_css_mobiletheme']    = 'Enter the custom css for mobile theme - Developer use only';
$_['entry_config_google_analytics']       = 'Google analytics script';
$_['entry_image_logo']                  =  'Logo Image Size';
$_['entry_image_mobile_logo']           =  'Mobile Logo Image Size';
...
$_['help_cart_limit']                  = 'Minimum total value required in the cart before it can be checked out.';
...
$_['help_seller_store']                = 'The seller for which the store data is displayed.';
...
$_['help_seller_comm']                 = 'Seller commission is the default commission wholesalebox would have for this store';
$_['help_config_store_body_wrapper_css'] = 'CSS which would be applied on body to have specific customization for a store - developer use only';
$_['help_config_store_custom_css']       = 'Write CSS which would be applied only for this store - Developer use only';
$_['help_config_google_analytics']       = 'Google analytics script';
$_['help_config_store_custom_css_mobiletheme']    = 'Enter the custom css for mobile theme - Developer use only';
...
$_['error_store_code']                 = 'Store Code must be between 2 and 16 characters!';
