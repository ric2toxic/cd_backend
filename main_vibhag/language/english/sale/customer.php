...
$_['entry_ip']              = 'IP';
$_['entry_order_count']     = 'Minimum Order Count';
$_['entry_date_added']      = 'Date Added';
$_['entry_umrn_lan']        = 'UMRN / LAN No';
...
$_['error_lazypay_mobile'] = 'Customer\'s lazypay mobile number should not be empty, if lazypay status is enabled';
$_['error_lazypay_email'] = 'Customer\'s lazypay email should not be empty, if lazypay status is enabled';
...
$_['text_bank_detail_edit']   = 'Update Customer Bank Details';
$_['bank_text_success']          = 'Success: You have modified customers bank detail!';
$_['btn_update_bank_detail']   = 'Update Bank Details';
$_['bank_back'] = 'Back';
$_['error_account_holder_name']    = 'Account Name must be between 1 and 32 characters!';
$_['error_account_number']         = 'Please Enter Account Number!';
$_['error_ifsc_code']              = 'Please Enter Ifsc code!';
$_['error_customer_vpa']           = 'Invalid UPI Vpa!';
$_['error_account_number_exist']           = 'Sorry this bank account is already used by another customer. Please provide a different bank a/c details.';
$_['error_account_number_block']           = 'Sorry this bank account is block. Please provide a different bank a/c details.';
