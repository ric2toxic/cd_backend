...
DROP TRIGGER IF EXISTS oc_product_option_value_insert_trigger |

CREATE DEFINER=`root`@`localhost` TRIGGER oc_product_option_value_insert_trigger 
AFTER INSERT ON oc_product_option_value
FOR EACH ROW
	BEGIN
