...
--
-- Table structure for table `oc_customer_credit_disbursal_request`
--

CREATE TABLE `oc_customer_credit_disbursal_request` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `oc_customer_credit_disbursal_request`
--
ALTER TABLE `oc_customer_credit_disbursal_request`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oc_customer_credit_disbursal_request`
--
ALTER TABLE `oc_customer_credit_disbursal_request`
