...
b = ['Fabric Type','Fabric Type','Size Set / Color Set', 'Style','Sleeve','Work Type','Length', 'Neck Type']
...
### ------The local_image_root is for image directory in local machine ----###							###############	
																										###############
server_image_root = "catalog/"+manufacturer_code+"/kurti/"												###############
local_image_root = "/Users/qurius/Documents/" +manufacturer_code+"/kurti/"								###############
																										###############
																										###############
#######################################################################################################################
#######################################################################################################################
...
######################################################################
cnx = MySQLdb.connect(user= 'root',passwd = 'p341987g',host = 'localhost',db = 'gnt_jp', conv = my_conv)
