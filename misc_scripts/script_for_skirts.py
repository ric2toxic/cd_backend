...
#######################################################################################################################
#######################################################################################################################
manufacturer_code =	"MFT_JP"

whether_img_folder  = 0																					###############
																										###############	
																										###############
...
### ------The local_image_root is for image directory in local machine ----###							###############	
																										###############
server_image_root = "catalog/"+manufacturer_code+"/western/"											###############
local_image_root = "/Users/qurius/Documents/" +manufacturer_code+"/western/"							###############
...
b = ['Fabric Type','Fabric Type','Color','Work Type','Length', 'Size']
...
######################################################################
cnx = MySQLdb.connect(user= 'root',passwd = 'p341987g',host = 'localhost',db = 'mftwestern', conv = my_conv)
