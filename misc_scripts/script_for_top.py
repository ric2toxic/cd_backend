...
# b = ['Fabric Type','Color', 'Style','Sleeve','Work Type','Length', 'Neck Type']
# b = ['Fabric Type','Set Type','Length','Sleeve' ,'Work Type', 'Neck Type', 'Product Type']
b = ['Fabric Type','Size Set / Color Set', 'Style','Sleeve','Work Type','Length', 'Neck Type']
...
### ------The local_image_root is for image directory in local machine ----###							###############	
																										###############
server_image_root = "catalog/"+manufacturer_code+"/top/"												###############
local_image_root = "/Users/qurius/Documents/" +manufacturer_code+"/top/"								###############
																										###############
																										###############
#######################################################################################################################
#######################################################################################################################
...
######################################################################
cnx = MySQLdb.connect(user= 'root',passwd = 'p341987g',host = 'localhost',db = 'tef_jp', conv = my_conv)
