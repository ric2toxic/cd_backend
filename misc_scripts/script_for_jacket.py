...
b = ['Fabric Type','Fabric Type','Work Type','Size']
...
### ------The local_image_root is for image directory in local machine ----###							###############	
																										###############
server_image_root = "catalog/"+manufacturer_code+"/jacket/"												###############
local_image_root = "/Users/qurius/Documents/" +manufacturer_code+"/jacket/"								###############
																										###############
																										###############
#######################################################################################################################
#######################################################################################################################
...
######################################################################
cnx = MySQLdb.connect(user= 'root',passwd = 'p341987g',host = 'localhost',db = 'kft_jp', conv = my_conv)
