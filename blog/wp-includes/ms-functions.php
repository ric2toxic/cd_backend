...
Disable these notifications: %4$s' ), $blogname, $siteurl, wp_unslash( $_SERVER['HTTP_X_FORWARDED_FOR'] ), $options_site_url);
	/**
...
Disable these notifications: %3$s'), $user->user_login, wp_unslash( $_SERVER['HTTP_X_FORWARDED_FOR'] ), $options_site_url);
...
function wpmu_log_new_registrations( $blog_id, $user_id ) {
	...
	if ( $user )
		$wpdb->insert( $wpdb->registration_log, array('email' => $user->user_email, 'IP' => preg_replace( '/[^0-9., ]/', '', wp_unslash( $_SERVER['HTTP_X_FORWARDED_FOR'] ) ), 'blog_id' => $blog_id, 'date_registered' => current_time('mysql')) );
}
