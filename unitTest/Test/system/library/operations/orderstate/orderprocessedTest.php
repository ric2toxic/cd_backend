 ...
 * Time: 5:17 PM
 */
 require_once(DIR_SYSTEM . '/library/operations/orders/orderprocessed.php');
 require_once( 'orderstatehelper.php');
 Class OrderProcessedTest extends OpenCartTest{
   private $helper;
   ...
   public function testDoActionIfPostStateNotExists(){
     $this->order_state_object = $this->helper->createOrderStateObject('OrderProcessed');
